class ReservaUI extends HTMLElement {

    constructor() {
        super();
        this.attachShadow({ mode: 'open' });
        this.shadowRoot.innerHTML = `
            <link rel="stylesheet" href="/activos/css/componentes.css">
            <style>
             .reservaDetalles_transacciones_enlacesDePago_infoSinEnlaces {
                display: flex;
                padding: 10px;
            ...
            p {
             ...
             .administracion_reservas_DetallesReserva_botonCategoria {
            ...
            @media (max-width: 720px) {
             ...
             .administracion_reservas_DetallesReserva_botonCategoria:hover {
                background: rgba(255, 255, 255, 0.6);
            }

             .reservaDetallesBloqueGeneral {
                border-radius: 12px;
                background-color: rgba(255, 255, 255, 0.3);
                backdrop-filter: blur(50px);
                -webkit-backdrop-filter: blur(50px);
             ...
             .administracion_reserva_detallesReserva_marcoMenuExpandido_horizontal {
                width: 100%;
                display: grid;
                grid-gap: 4px;
                padding: 0px;
             ...
             .miCasa_reserva_detallesReserva_marcoMenuExpandido_horizontal {
                width: 100%;
                display: grid;
                grid-gap: 4px;
                padding: 0px;
             ...
             .administracion_reserva_detallesReserva_marcoMenuResponsivo {
                border-radius: 12px;
                background-color: rgba(255, 255, 255, 0.3);
                backdrop-filter: blur(50px);
                -webkit-backdrop-filter: blur(50px);
             ...
             .administracion_reservas_detallesReserva_contenedorMenuExpandido {
                display: grid;
                grid-template-columns: auto auto auto auto auto auto auto 50px;
                gap: 6px;
            }
            ...
            @media screen and (max-width: 968px) {
             ...
             .administracion_reserva_detallesReserva_marcoMenuResponsivo:hover {
                background: #0040ff;
                color: white;
            }

             .reservaDetallesBloqueAlojamineto {
                border-radius: 12px;
                padding: 6px;
                display: flex;
                flex-direction: column;
             ...
             .administracionReservaDetallesBloqueContendioAlojamiento {
                display: flex;
                align-items: stretch;
                justify-content: center;
                flex-direction: column;
             ...
             .administracionReservaBloqueDual {
                display: flex;
                align-items: center;
                justify-content: center;
                flex-direction: column;
             ...
             .administracion_reservas_detallesReserva_contenedorReservaUID {
                display: flex;
                align-items: stretch;
                justify-content: center;
                flex-direction: column;
             ...
             .administracion_reservas_detallesReserva_contenedorRestoGlobal {
                display: grid;
            ...
            @media screen and (max-width: 600px) {
             ...
             .administracion_reservas_detallesReserva_panel_bloqueTitular {
                display: flex;
                align-items: stretch;
                justify-content: center;
                flex-direction: column;
             ...
             .administracion_reservas_detallesReserva_panel_bloqueTitular:hover {
                background: rgba(255, 255, 255, 0.3);
            }

             .administracionReservasDetallesBloqueApartamento {
             ...
             .tituloApartamento:hover {
                background: rgba(0, 0, 0, 0.1);
            }

             .tituloApartamento,
            .tituloApartamento_noSel {
                padding: 10px;
                font-weight: bold;
             ...
             .administracionReservasDetallesBloqueHabitacion {
                overflow: hidden;
                background: #00000014;
                border-radius: 10px;
                padding: 6px;
             ...
             .administfcomportamientoBotonracionReservasDetallesTituloTipoCama {
                background: rgba(0, 0, 0, 0.2);
                user-select: none;
                cursor: default;
            }

             .administracionReservasDetallesBloquePernoctantes {
                user-select: none;
                -webkit-user-select: none;
                padding: 10px;
                border-radius: 7px;
             ...
             .administracionReservasDetallesBloquePernoctantesNoAlojado {
             ...
             .bloquePernoctanteNoAlojadoInerte {
                background: rgba(0, 0, 0, 0.139);
                user-select: none;
                padding: 10px;
                border-radius: 10px;
             ...
             .administracionReservasDetallesBloquePernoctantesNoAlojado:hover {
                background-color: rgba(1, 1, 1, 0.3);
            }

             .administracionReservasDetallesNombrePernoctante {
                font-weight: bold;
            }

             .administracion_reservas_detallesReserva_tituloCheckIn {
                color: rgb(0, 140, 40);
            }
             ...
             .administracion_reservas_detallesReserva_tituloPendienteComprobacion {
                pointer-events: none;
                color: rgb(0 11 168);
            }

             .reservasDetallesBloqueAlojamiennto {
                display: grid;
                grid-gap: 6px;
                grid-auto-rows: minmax(auto, auto);
                justify-items: stretch;
            ...
            @media screen and (max-width: 720px) {
             ...
             .adminsitracionReservasTituloNombre {
                font-weight: bold;
                text-align: center;
            }

             .adminsitracion_reservas_detallesReserva_contenedorDatoGlobal {
                text-align: center;
            }


             .administracionReservasDetallesBloquePernoctantes:hover {
                background: rgba(255, 255, 255, 0.6);
            }

             .administracionReservasDetallesBloqueOpcionesCliente {
                display: flex;
                flex-direction: column;
                align-items: stretch;
                justify-content: center;
             ...
             .administracionReservasDetalesMarcoEnvolventeInformacionGeneral {
                border-radius: 12px;
            ...
            @media screen and (max-width: 720px) {
             ...
             .administracionReservasDetallesBotonOpcionCliente {
                padding: 10px;
                border-radius: 10px;
                cursor: default;
                user-select: none;
             ...
             .administracionReservasDetallesBotonOpcionCliente:hover {
                color: white;
                background: rgba(0, 0, 0, 0.5);
            }

             .fechaEntradaElemento,
             .fechaSalidaElemento {
                border-radius: 7px;
                padding: 8px;
            }

             .fechaEntradaElemento:hover {
                background: rgba(255, 255, 255, 0.3);
            }

             .fechaSalidaElemento:hover {
                background: rgba(255, 255, 255, 0.3);
            }

             .componenteFechaEntrada:hover~.fechaSalidaElemento {
                background: rgba(255, 255, 255, 0.3);
            }

             .panelOpcionesCambioCama {
                background: rgba(255, 255, 255, 0.3);
                position: absolute;
             ...
             .opcionCambioCama:hover {
                background: #0040ff;
                color: white;
            }

             .administracion_reservas_detallesReservas_menuAnadirApartamento {
                position: absolute;
                width: 100%;
                display: grid;
             ...
             .administracion_reservas_detallesReservas_menuAnadirApartamento .infoCargando {
                padding: 10px;
                text-align: center;
            }

             .reservaDetalles_menu_apartamentosDipsonbiles {
                display: flex;
                flex-direction: column;
                gap: 12px;
            }

             .reservaDetalles_menu_apartamentosNoDipsonbiles {
                display: flex;
                flex-direction: column;
                gap: 12px;
            }

             .menuFlotanteOpcionApartamentoNoDisponible {
             ...
             .reservaDetalles_menu_titutloapartamentosDisponibles {
                padding: 10px;
                font-weight: bold;
            }

             .resertaDetallesPernoctantesSinalojamiento {
                background-color: rgba(255, 255, 255, 0.3);
                border-radius: 12px;
                margin: 0px;
                backdrop-filter: blur(50px);
             ...
             .administracion_reservas_detallesReservas_tituloPernoctantesSinHabitacion {
                display: flex;
                padding: 4px;
                flex-direction: column;
                align-items: center;
             ...
             .administracion_reservas_detallesReserva_contenedorPernoctantesSinHabitacion {
                padding: 6px;
                border-radius: 12px;
                max-width: 1920px;
                display: grid;
             ...
             .resertaDetallesPropuestaCambioFechaReserva {
                padding: 4px;
                background-color: rgba(255, 255, 255, 0.3);
                border-radius: 12px;
                margin: 0px;
             ...
             .reserva_resumen_desglose_pago_elemento {
                border-radius: 10px;
                padding: 10px;
                border-radius: 10px;
                background: rgba(255, 255, 255, 0.3);
             ...
             .detallesReservaCancelarReservaBloqueBloqueoApartamentos {
                border-radius: 12px;
                gap: 6px;
                display: flex;
                flex-direction: column;
             ...
             .detallesReservaCancelarReservaTituloBloquoApartamentos {
                margin: 0px;
                padding: 6px;
                display: flex;
                flex-direction: column;
             ...
             .detallesReservaCancelarReservabloqueBotones {
             ...
             [espacio=formularioCrearPagoManual] .info {
                display: flex;
                gap: 10px;
                padding: 10px;
                justify-items: stretch;
             ...
             .administracion_reservas_detallesReservas_check_botonConfirmar {
                background: #00000036;
                padding: 8px;
                pointer-events: none;
                border-radius: 8px;
             ...
             .administracion_reservas_detallesReservas_check_botonConfirmar:hover {
                background: green;
                color: white;
            }

             .administracion_reservas_detallesReserva_cancelarReserva_botonV1 {
                background: #00000036;
                padding: 8px;
                border-radius: 8px;
                border-radius: 8px;
             ...
             .administracion_reservas_detallesReserva_cancelarReserva_botonV1:hover {
                color: white;
                background: red;
            }

             .administracion_reservas_detallesReservas_cancelarReserva_contenedorCancelacion {
                display: flex;
                gap: 6px;
                flex-direction: column;
                align-items: stretch;
             ...
             .elementoOcultoInicialmente {
                display: none;
            }

             .administracion_reservas_detallesReserva_contenedorCategoriasGlobales {
                display: flex;
                align-items: stretch;
                flex-direction: column;
            }

             .compomentes_ui_totales_ofertas_contenedorConjuntoOferta {
                display: flex;
                flex-direction: column;
                gap: 10px;
                background: rgba(255, 255, 255, 0.3);
             ...
             .usuariosCrearCuenta_campoUsuario {
                border-radius: 10px;
                padding: 10px;
                border: none;
                outline: none;
             ...
             .detallesReserva_campoNombreEnlace {
                background: rgba(255, 255, 255, 0.3);
                border-radius: 10px;
                padding: 10px;
                border: none;
             ...
             .detallesReserva_reembolso_tituloGlobal {
                font-size: 20px;
                font-weight: bold;
                margin: 4px;
                text-align: center;
             ...
             .detallesReserva_reembolso_campoConfirmacion {
                padding: 9px;
                outline: none;
                border: none;
                border-radius: 6px;
             ...
             .detallesReserva_reembolso_bloqueInterno_campoConfiramcion {
                display: flex;
                gap: 6px;
                flex-direction: column;
            }

             .detallesReserva_rembolso_contenedorEmitirReembolso {
                background: rgba(255, 255, 255, 0.3);
                display: flex;
                flex-direction: column;
                flex-wrap: nowrap;
             ...
             .detallesReserva_reembolso_campo {
                padding: 10px;
                border-radius: 10px;
                outline: none;
                border: none;
             ...
             .detallesReserva_reemboldo_bloqueEmitirReembolso {
                gap: 6px;
                row-gap: 6px;
                column-gap: 6px;
                display: flex;
             ...
             .detallesReserva_reembolso_emitirReembolso_texto {
                padding: 4px;
            }

             .detallesReserva_reembolso_emitirReembolso_contenedorBotones {
                display: grid;
             ...
             .detallesReserva_reembolso_emitirReembolso_botonTipoReembolso {
             ...
             .detallesReserva_reembolso_emitirReembolso_contenedorTipoReembolsos {
                display: grid;
             ...
             .detallesReserva_rembolso_contenedorDiamicoTipo {
                display: flex;
                flex-direction: column;
                flex-wrap: nowrap;
                padding: 0px;
             ...
             .detallesReserva_rembolso_contenedorPorCantidad {
                display: flex;
                flex-direction: column;
                flex-wrap: nowrap;
                padding: 0px;
             ...
             .detallesReserva_rembolso_contenedorPorPorcentaje {
                display: flex;
                flex-direction: column;
                flex-wrap: nowrap;
                padding: 0px;
             ...
             .detallesReserva_transacciones_bloqueGlobal {
                display: flex;
                flex-direction: column;
                flex-wrap: nowrap;
                border-radius: 7px;
             ...
             .detallesReserva_enlacesDePago_bloqueDatosGenerales {
            ...
            @media (max-width: 720px) {
             ...
             .detallesReserva_transacciones_bloqueDatosGenerales {
                background: rgba(255, 255, 255, 0.4);
                display: flex;
                flex-direction: row;
                flex-wrap: nowrap;
             ...
             .administracion_reservas_detallesReservas_enlacesDePago_botonV1 {
                background: rgba(255, 255, 255, 0.4);
                display: flex;
                border-radius: 11px;
                align-items: center;
             ...
             .administracion_reservas_detallesReservas_enlacesDePago_botonV1:hover {
                background: white;
            }

             .administracion_reservas_detallesReservas_enlacesDePago_botonCopiarPulsacion:active {
                background: black;
                color: white;
            }

             .administracion_reservas_detallesReservas_enlacesDePago_contenedorBotones {
                display: flex;
                gap: 6px;
                flex-direction: column;
            }

             .detallesReserva_transacciones_bloqueBotones {
                display: flex;
                justify-items: end;
                justify-content: flex-start;
                align-content: center;
             ...
             .detallesReserva_enlacesDePago_bloqueBotones {
                display: flex;
                justify-items: end;
                justify-content: flex-start;
                align-content: center;
             ...
             .detallesReserva_transacciones_botonV1 {
                display: flex;
                padding: 10px;
                border-radius: 11px;
                text-decoration: none;
             ...
             .detallesReserva_transacciones_botonV1:hover {
                background: white;
            }

             .reservaDetalles_transacciones_bloqueDetallesDelPago {
                padding: 10px;
                border-radius: 9px;
                display: flex;
                flex-direction: column;
             ...
             .reservaDetalles_transacciones_bloque_miCasa {
                padding: 10px;
                border-radius: 9px;
                display: flex;
                flex-direction: column;
             ...
             .reservaDetalles_transacciones_bloqueDetallesDelPago:hover {
                background: rgba(0, 0, 0, 0.3);
            }

             .administracion_reservas_detallesReserva_contenedorDinamico {
                border-radius: 12px;
                background-color: rgba(255, 255, 255, 0.3);
                backdrop-filter: blur(50px);
                -webkit-backdrop-filter: blur(50px);
             ...
             .administracion_reservas_detallesReserva_contenedorListaDePagos {
                display: flex;
                flex-direction: column;
                padding: 6px;
            }

             .administracion_reservas_detallesReserfa_miscelanea_botonOpcion {
                cursor: default;
                user-select: none;
                text-decoration: none;
                -webkit-user-select: none;
             ...
             .administracion_reservas_detallesReserfa_miscelanea_botonOpcion:hover {
                background-color: rgba(255, 255, 255, 0.6);
            }

             .detallesReserva_reembolso_infoGlobal {
                display: flex;
                justify-content: center;
                padding: 8px;
            }

             .administracion_reservas_detallesReservas_enlacesDePago_contenedorDatosEnlace {
                display: flex;
                gap: 10px;
                padding: 4px;
                flex-direction: column;
             ...
             .administracion_reservas_detallesReservas_transacciones_reembolsos_contenedorReembolsoEnDetalle_tituloReembolso {
                margin: 6px;
            }

             .administracion_reservas_detallesReservas_transacciones_reembolsos_contenedorReembolsoEnDetalle_bloque {
                margin: 6px;
            }

             .administracion_reservas_detallesReservas_transacciones_reembolsos_contenedorReembolsoEnDetalle {
                display: flex;
                flex-direction: column;
                padding: 6px;
                border-radius: 12px;
             ...
             .administracion_reservas_detallesReserva_transacciones_reembolsos_contenedorReembolso {
                display: flex;
                flex-direction: column;
                gap: 6px;
            }

             .administracion_reservas_detallesReserva_transacciones_reembolsos_contenedorCrearReembolso {
                display: none;
                flex-direction: column;
                gap: 6px;
            }

             .administracion_reservas_reservaDetalles_transacciones_reembolsos_bloqueDetallePago {
                background: rgba(0, 0, 0, 0.1);
                padding: 14px;
                border-radius: 9px;
                display: flex;
             ...
             .administracion_reservas_reservaDetalles_transacciones_reembolsos_tituloDetallesPago {
                margin: 0px;
                padding: 6px;
            }

             .administracion_reservas_reservaDetalles_transacciones_reembolsos_bloqueTitulo {
                border-radius: 12px;
                padding: 4px;
                gap: 4px;
                row-gap: 4px;
             ...
             .administracion_reservas_detallesReserva_transacciones_reembolsos_contenedorBotones {
                border-radius: 12px;
                gap: 10px;
                display: flex;
                justify-content: center;
             ...
             .administracion_reservas_detallesReserva_transacciones_reembolsos_botonV1 {
                background: rgba(255, 255, 255, 0.3);
                padding: 10px;
                border-radius: 10px;
                text-align: center;
             ...
             .boton_opciones_reembolso_v2 {
                background: rgba(255, 255, 255, 0.3);
                padding: 10px;
                border-radius: 6px;
            }

             .administracion_reservas_detallesReserva_transacciones_reembolsos_botonV1:hover {
                background: white;
            }

             .administracion_reservas_detallesReserva_transacciones_reembolsos_detallesReembolso_contenedorBotones {
                border-radius: 12px;
                gap: 6px;
                display: flex;
             ...
             .administracion_reservas_detallesReservas_transacciones_contenedorListaDePagos {
                display: flex;
                justify-content: center;
                flex-direction: column;
            }

             .administracion_reservas_detallesReserva_transacciones_pagoManual_contenedorTipoPago {
                display: none;
                flex-direction: column;
                align-items: stretch;
                gap: 6px;
             ...
             .administracion_reservas_detallesReserva_infoTitular_contenedorGlobal {
                background: rgb(255 255 255 / 0.3);
                border-radius: 10px;
                padding: 14px;
                display: flex;
             ...
             .administracion_reservas_detallesReserva_checkin_infoTitular_contenedorGlobal {
                background: rgb(255 255 255 / 0.3);
                border-radius: 20px;
                padding: 20px;
                display: flex;
             ...
             .reservaDetalles_transacciones_textoV1 {
                padding: 6px;
                text-align: center;
            }

             .administracion_reservas_detallesReserva_transacciones_eliminarPagoManual {
                display: flex;
                flex-direction: column;
                align-items: stretch;
                gap: 6px;
             ...
             .plaza_alojamiento_reservaConfirmada_botoDescargaPDF {
                text-decoration: none;
                background: rgb(255 255 255 / 0.3);
                border-radius: 10px;
                padding: 10px;
             ...
             .plaza_alojamiento_reservaConfirmada_botoDescargaPDF:hover {
                background: white;
            }

             .administracion_calendario_contenedorCalentadioIntermedio {
                display: flex;
                flex-direction: column;
                justify-content: center;
                align-content: center;
             ...
             .componentes_ui_desloseTotales_contenedor {
                display: flex;
                flex-direction: column;
                gap: 6px;
            }

             .administracion_reserver_detallesReserva_contenedorDesgloseTotal {
                display: flex;
                flex-direction: column;
                align-items: stretch;
            }

             .administracion_reservas_detallesReservas_check_contenedor {
                padding: 10px;
                display: flex;
                gap: 6px;
                flex-direction: column;
             ...
             .administracion_reserva_detallesReserva_cancelarReserva_eliminarReserva_campo {
                outline: none;
                border: none;
                padding: 10px;
                border-radius: 10px;
             ...
             .detallesReservaCancelarBoton:hover {
                color: white;
                background: #0040ff;
            }

             .detallesReservaTituloCancelarReserva {
                font-size: 20px;
                font-weight: bold;
                margin: 4px;
                text-align: center;
             ...
             .administracion_reservas_detallesReseerva_iconoMiscelanea {
                background: #00000075;
                height: 4px;
                width: 100%;
                border-radius: 100px;
            ...
            [servicioUID] .contenedorGlobal {
                display: grid;
                grid-template-columns: auto auto 1fr !important;
                align-items: center;
            }

            [cancelarReservaTipoBloqueo=rangoTemporal],
            [cancelarReservaTipoBloqueo=permanente] {
                color: red;
            }

            [cancelarReservaTipoBloqueo=sinBloqueo] {
                color: green;
            }
    ...
    arranque() {
        this.reserva = {
            reservaUI: {
                despliege: async (data) => {
                    const reservaUID = data.reservaUID
                    this.reserva.data = {
                        reservaUID: reservaUID,
                        configuracionVista: data.configuracionVista
                    }

                    const configuracionVista = data.configuracionVista
                    const reserva = await this.reserva.reservaUI.global.obtenerReserva({
                        reservaUID,
                        configuracionVista
                    })
                    const reservaUI = await this.reserva.reservaUI.ui.despliege({
                        reserva,
                        configuracionVista
                    })
                    ...
                    if (configuracionVista === "publica") {
                        ...
                        titularUI.addEventListener("click", () => {
                            this.reserva.reservaUI.titular.desplegarUI(reservaUID)
                        })
                        estadoReservaUI.addEventListener("click", () => {
                            this.reserva.reservaUI.estado.panelExpandidoUI(reservaUID)
                        })
                    }
                    const destino = this.shadowRoot.getElementById('container');
                    destino.appendChild(reservaUI)
                },
                ui: {
                    despliege: async (data) => {
                        const configuracionVista = this.reserva.data.configuracionVista
                        ...
                        const contenedor = this.reserva.reservaUI.ui.componentesUI.contenedor(reservaUID)

                        const estadoPendienteUI = this.reserva.reservaUI.ui.componentesUI.estadoPendienteUI.despliege({
                            estadoReservaIDV,
                            reservaUID
                        })
                        contenedor.appendChild(estadoPendienteUI)
                        const panelGlobal = this.reserva.reservaUI.ui.componentesUI.bloqueGlobal.despliege(reserva)
                        contenedor.appendChild(panelGlobal)
                        const barraProgress = this.reserva.reservaUI.ui.componentesUI.barraProgreso({
                            reservaUID,
                            porcentajeTranscurrido
                        })
                        contenedor.appendChild(barraProgress)

                        const contenedorFechas = document.createElement("contenedor-fechas")
                        contenedorFechas.setAttribute("com", "contenedorFechas")
                        contenedor.appendChild(contenedorFechas);

                        const comJS_contenedorFechas = document.createElement("script")
                        comJS_contenedorFechas.src = "/componentes/contenedor_fechas"
                        comJS_contenedorFechas.addEventListener('load', () => {

                            const com = this.shadowRoot.querySelector('[com=contenedorFechas]');
                            com.arranque()

                            com.contenedorFechasUI({
                        ...
                        contenedor.appendChild(comJS_contenedorFechas)
                        ...
                        // const contenedorBotones = this.reserva.reservaUI.ui.componentesUI.categoriasGlobalesUI.despliege({
                        //     rectangularidad: "horizontal",
                        //     reservaUID: reservaUID,
                        //     configuracionVista
                        // })
                        // contenedor.appendChild(contenedorBotones);
                        const contenedorDinamico = this.reserva.reservaUI.ui.componentesUI.contenedorDinamico()
                    ...
                    componentesUI: {
                        ...
                        estadoPendienteUI: {
                            despliege: (data) => {
                                ...
                                const reservaUID = this.reserva.data.reservaUID
                                const contenedor = document.createElement("div")
                                ...
                                botonAceptar.addEventListener("click", () => {
                                    this.reserva.reservaUI.ui.componentesUI.estadoPendienteUI.com.aceptarReserva({
                                        reservaUID
                                    })
                                })
                                ...
                                botonRechazar.addEventListener("click", () => {
                                    this.reserva.reservaUI.ui.componentesUI.estadoPendienteUI.com.rechazarReserva({
                                        reservaUID
                                    })
                                })
                            ...
                            com: {
                                ...
                                rechazarReserva: async (data) => {
                                    ...
                                    botonRechazar.addEventListener("click", (e) => {
                                        this.reserva.categoriasGlobales.cancelarReserva.confirmaCancelacion({
                                ...
                                ponerReservaEnPendiente: async (data) => {
                                    const reservaUID = this.reserva.data.reservaUID
                                    const pantallaInmersiva = casaVitini.ui.componentes.pantallaInmersivaPersonalizadaMoldeada()
                                    const constructor = pantallaInmersiva.querySelector("[componente=constructor]")
                                    const instanciaUID_aceptarReserva = pantallaInmersiva.getAttribute("instanciaUID")
                                ...
                                confirmarNuevoEstado: async (data) => {
                                    const reservaUID = this.reserva.data.reservaUID
                                    const nuevoEstado = data.nuevoEstado
                                    const instanciaUID_aceptarReserva = data.instanciaUID_aceptarReserva
                                    const ui = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_aceptarReserva}"]`)
                                    ...
                                    const uiRenderizada = this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"]`)
                                ...
                                panelExpandidoUI: async (data) => {
                                    ...
                                    const botonCancelar = constructor.querySelector("[boton=cancelar]")
                                    botonCancelar.textContent = "Cancelar y volver"
                                    this.shadowRoot.appendChild(pantallaInmersiva)
                                }
                            }
                        },
                        bloqueGlobal: {
                            despliege: (data) => {
                                ...
                                const reservaUI = this.reserva.reservaUI.ui.componentesUI.bloqueGlobal.com.reservaUI(reservaUID)
                                ...
                                configuracionGlobal.forEach((c) => {
                                    const menuGlobalUI = this.reserva.reservaUI.ui.componentesUI.bloqueGlobal.com.infoGlobalUI(c)
                        ...
                        categoriasGlobalesUI: {
                            despliege: () => {
                                ...
                                botonNuevaReserva.addEventListener("click", (e) => {
                                    e.preventDefault()
                                    this.reserva.reservaUI.ui.componentesUI.categoriasGlobalesUI.controladorCategorias({
                                ...
                                botonCompAlo.addEventListener("click", (e) => {
                                    ...
                                    this.reserva.reservaUI.ui.componentesUI.categoriasGlobalesUI.controladorCategorias(metadatos)
                                })
                            ...
                            desplegarMenuResponsivo: () => {
                                ...
                                const controlResponsivoVisibilidad = () => {
                                    const selectorElementoObservado = this.shadowRoot.querySelector("[controlador=controlResponsivoVisibilidad]")
                            ...
                            ocultaCategorias: () => {
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas();
                                this.reservaUI.ui.componentesUI.categoriasGlobalesUI.limpiarMenusCategorias()
                                this.shadowRoot.querySelector("[componente=contenedorDinamico]").innerHTML = null
                            },
                            limpiarMenusCategorias: () => {
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas();
                                console.log("this", this.shadowRoot.querySelector("[componente=iconoLineaMiscelanea]"))
                                this.shadowRoot.querySelector("[componente=iconoLineaMiscelanea]").removeAttribute("style")
                                const botonesCategoria = this.shadowRoot.querySelectorAll("[categoriaReserva]")
                                botonesCategoria.forEach((boton) => {
                                    boton.removeAttribute("style")
                                    boton.setAttribute("estadoCategoria", "otra")
                                })
                                this.shadowRoot.querySelector("[componente=contenedorDinamico]").innerHTML = null
                                const contenedorDinamico = this.shadowRoot.querySelector("[componente=contenedorDinamico]")
                            ...
                            controladorCategorias: async (metadatos) => {
                                ...
                                const selectorBotonCategoriaRenderizado = this.shadowRoot.querySelector(`[categoriaReserva="${categoriaIDV}"]`)
                                const estadoCategoria = selectorBotonCategoriaRenderizado?.getAttribute("estadoCategoria")
                                const categoriaActual = this.shadowRoot.querySelector("[estadoCategoria=actual]")?.getAttribute("categoriaReserva")
                                this.reserva.reservaUI.ui.componentesUI.categoriasGlobalesUI.limpiarMenusCategorias()
                                ...
                                const constructorDireccionFuncion = this.reserva.categoriasGlobales[categoriaIDV]?.arranque
                                if (typeof constructorDireccionFuncion === "function") {
                                    const botonCategoriaGlobal = this.shadowRoot.querySelector(`[categoriaReserva=${categoriaIDV}]`)
                                    botonCategoriaGlobal.style.background = "blue"
                                    botonCategoriaGlobal.style.color = "white"
                                    await this.reserva.categoriasGlobales[categoriaIDV]?.arranque();
                ...
                fechas: {
                    seleccionarDia: function (dia_) {
                        ...
                        if (diaSeleccionadoComoElemento.getAttribute("estadoDia") === "seleccionado") {
                            ...
                            if (calendarioIO === "entrada") {
                                this.shadowRoot.querySelector("[componente=bloquePropuestaNuevaFechaEntrada]")?.remove()
                                diaSeleccionadoComoElemento.style.background = ""
                                diaSeleccionadoComoElemento.style.color = ""
                            }
                            if (calendarioIO === "salida") {
                                this.shadowRoot.querySelector("[componente=bloquePropuestaNuevaFechaSalida]")?.remove()
                                diaSeleccionadoComoElemento.style.background = ""
                                diaSeleccionadoComoElemento.style.color = ""
                            }
                            diaSeleccionadoComoElemento.removeAttribute("estadoDia")
                            this.reserva.reservaUI.fechas.controladorZonaPropuestasCambioFechas()
                        }
                        this.shadowRoot.querySelectorAll("[estado=disponible]").forEach(diaDisponible => {
                        ...
                        const anoSeleccionado = this.shadowRoot.querySelector("[componente=mesReferencia]").getAttribute("ano").padStart(4, "0")
                        const mesSeleccionado = this.shadowRoot.querySelector("[componente=mesReferencia]").getAttribute("mes").padStart(2, "0")
                        const selectorPropuestaCambioFecha = this.shadowRoot.querySelector("[componente=espacioPropuestaCambioFechaReserva]")
                        const reservaUID = this.reserva.data.reservaUID
                        ...
                        this.shadowRoot.appendChild(propuestaUI)
                        ...
                        if (calendarioIO === "entrada") {
                            ...
                            botonAceptarPropuesta.addEventListener("click", () => {
                                this.reserva.reservaUI.fechas.confirmarCambioFecha({
                    ...
                    confirmarCambioFecha: async function (propuesta) {
                        ...
                        if (respuestaServidor?.error) {
                            ...
                            this.reserva.reservaUI.actualizarReservaRenderizada()
                            if (sentidoRangoRespueata === "pasado") {
                                const selectorFechaEntrada = this.shadowRoot.querySelector("[calendario=entrada]")
                                const selectorFechaEntradaUI = this.shadowRoot.querySelector("[fechaUI=fechaInicio]")
                            ...
                            if (sentidoRangoRespueata === "futuro") {
                                const selectorFechaSalida = this.shadowRoot.querySelector("[calendario=salida]")
                                const selectorFechaSalidaUI = this.shadowRoot.querySelector("[fechaUI=fechaFin]")
                                selectorFechaSalida.setAttribute("memoriaVolatil", fecha_ISO)
                                selectorFechaSalidaUI.textContent = fecha_Humano
                            }
                            casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                            const selectorMarcoAlojamiento = this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"] [componente=marcoAlojamiento]`)
                            if (selectorMarcoAlojamiento) {
                                //  this.reserva.categoriasGlobales.alojamiento.arranque()
                            }
                        }
                    },
                    controladorZonaPropuestasCambioFechas: () => {
                        const selectorZonaPropuestas = this.shadowRoot.querySelector("[componente=espacioPropuestaCambioFechaReserva]").childElementCount
                        if (selectorZonaPropuestas > 0) {
                            this.shadowRoot.querySelector("[componente=espacioPropuestaCambioFechaReserva]").style.display = "grid"
                        } else {
                            this.shadowRoot.querySelector("[componente=espacioPropuestaCambioFechaReserva]").style.display = "none"
                        }
                    },
                ...
                titular: {
                    desplegarUI: async (reservaUID) => {
                        document.body.style.overflow = "hidden";
                        const main = this.shadowRoot
                        const contexto = this.reserva.reservaUI.titular

                        console.log("prier this", this)
                        const ui = casaVitini.ui.componentes.pantallaInmersivaPersonalizada()
                        ...
                        const ui_renderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
                        ...
                        if (respuestaServidor?.ok) {
                            ...
                            const tituloUI = function (titulo) {
                                console.log("segundo this", this)
                                return contexto.componentes.titulo(titulo)
                            }
                            const infoUI = (info) => {
                                return contexto.componentes.infoUI(info)
                            }
                            const detallesDelTitularUI = (data) => {
                                return contexto.componentes.detallesDelTitularUI(data)
                            }
                            const botonIrALaFichaDelClinete = (clienteUID) => {
                                return contexto.componentes.botonIrALaFichaDelClinete(clienteUID)
                            }
                            const botonCambiarTitular = (instanciaUID) => {
                                return contexto.componentes.botonCambiarTitular(instanciaUID)
                            }
                            const botonDesasociar = (data) => {
                                return contexto.componentes.botonDesasociar(data)
                            }
                            const botonCerrarFormularioExpandidoCambiarTitular = (instanciaUID) => {
                                return contexto.componentes.botonCerrarFormularioExpandidoCambiarTitular(instanciaUID)
                            }
                            const buscadorUI = (reservaUID) => {
                                return this.reserva.categoriasGlobales.alojamiento.pernoctantes.gestionPernoctante.componentes.buscadorRapido.UI({
                                    reservaUID: reservaUID,
                            ...
                            const formularioNuevoTitular = (reservaUID) => {
                                return this.reserva.categoriasGlobales.alojamiento.pernoctantes.gestionPernoctante.componentes.nuevoClienteOTitular.UI({
                    ...
                    componentes: {
                        transacciones: {
                            asociarTitularConLaReserva: async (data) => {
                                const reservaUID = this.reserva.data.reservaUID
                                ...
                                const pantallaDeCargaRenderizada = this.shadowRoot.querySelector(`[pantallaSuperpuesta=pantallaCargaSuperpuesta][instanciaUID="${instanciaUIDPantallaDeCarga}"]`)
                                const respuestaServidor = await casaVitini.shell.servidor({
                                ...
                                if (respuestaServidor?.ok) {
                                    ...
                                    const selectorNombreTitularRenderizado = this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"]`)
                                    const selectorNombreTitular = this.shadowRoot.querySelector(`[dataReserva=nombreTitular]`)
                                    if (selectorNombreTitularRenderizado && selectorNombreTitular) {
                                        selectorNombreTitular.textContent = nombreCompleto
                                        const selectorBloqueTitular = this.shadowRoot.querySelector(`[contenedor=titular]`)
                                    ...
                                    const instanciaUID_renderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
                            ...
                            desasociarClienteComoTitular: async function (metadatos) {
                                ...
                                if (respuestaServidor?.ok) {
                                    pantallaDeCargaRenderizada?.remove()
                                    const selectorNombreTitularRenderizado = this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"]`).querySelector(`[dataReserva=nombreTitular]`)
                                    ...
                                    const selectorDestinoRenderizado = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
                        ...
                        cambiarTitular: function (instanciaUID) {
                            const selectorBotonCambiarTitular = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"] [boton=cambiarTitular]`)
                            const selectorBotonDesasociar = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"] [boton=desasociarTitular]`)
                            selectorBotonCambiarTitular.style.display = "none"
                            selectorBotonDesasociar.style.display = "none"
                            const selectorNuevoClienteUI = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"] [formulario=nuevoCliente]`)
                            selectorNuevoClienteUI.removeAttribute("style")
                            const selectorBuscadorRapidoClienteUI = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"] [contenedor=buscador]`)
                            selectorBuscadorRapidoClienteUI.removeAttribute("style")
                            const selectorbotonCerrarCambiarTitular = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"] [boton=cerrarCambiarTitular]`)
                ...
                estado: {
                    ...
                    panelExpandidoUI: async (reservaUID) => {
                        const estadoActual = this.shadowRoot.querySelector("[contenedor=panelGlobal] [contenedor=estadoReserva] [estadoReservaIDV]").getAttribute("estadoReservaIDV")
                        const pantallaInmersiva = casaVitini.ui.componentes.pantallaInmersivaPersonalizadaMoldeada()
                        pantallaInmersiva.style.justifyContent = "center"
                        const constructor = pantallaInmersiva.querySelector("[componente=constructor]")
                        const instanciaUID_aceptarReserva = pantallaInmersiva.getAttribute("instanciaUID")
                ...
                actualizarReservaRenderizada: async () => {
                    const reservaUID = this.reserva.data.reservaUID
                    const instanciaUID = this.shadowRoot.getAttribute("instanciaUID")
                    const selectorEstadoPago = this.shadowRoot.querySelector("[dataReserva=estadoPago]")
                    const selectorTotalConImpuestos = this.shadowRoot.querySelector("[dataReserva=totalReservaConImpuestos]")
                    ...
                    const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                    const selectorUIRenderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_paraSelectores}"]`)
                    ...
                    if (respuestaServidor?.ok) {
                        ...
                        const section = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
                        ...
                        if (selectorListaDePagosRenderizada) {
                            this.reserva.categoriasGlobales.transacciones.actualizarDatosGlobalesPago({
                                reservaUID
                            })
                        }
                        if (selectorDesgloseFinancieroUIRenderizado) {
                            this.reserva.categoriasGlobales.desgloseTotal.controladores.desplegarContenedorFinanciero({
                                reservaUID
                            })
                        }
                    }
                ...
                rechazarReserva: {
                    UI: function (metadatos) {
                        ...
                        botonCancelar.addEventListener("click", () => {
                            this.reserva.categoriasGlobales.cancelarReserva.eliminarReservaIrreversiblemente.confirmar({
                                reservaUID,
            ...
            categoriasGlobales: {
                alojamiento: {
                    arranque: async () => {
                        ...
                        const reservaUID = this.reserva.data.reservaUID
                        console.log("reservaUID", reservaUID, typeof reservaUID)
                        const configuracionVista = this.reserva.data.configuracionVista
                        const contenedorDinamico = this.shadowRoot.querySelector("[componente=contenedorDinamico]")
                        ...
                        const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                        const instanciaDestino = this.shadowRoot.querySelector(`[componente=marcoAlojamiento][instanciaUID="${instanciaUID}"]`)
                        ...
                        if (respuestaServidor?.ok) {
                            ...
                            botonAnadirApartamento.addEventListener("click", this.reserva.categoriasGlobales.alojamiento.apartamentos.abrirMenuReservas)
                            ...
                            for (const [apartamentoIDV, configuracionApartamento] of Object.entries(alojamiento)) {
                                ...
                                const apartamentoComponenteUI = this.reserva.categoriasGlobales.alojamiento.apartamentos.apatamentoUI({
                                    apartamentoIDV: apartamentoIDV,
                                    apartamentoUID: apartamentoUID,
                                    apartamentoUI: apartamentoUI
                                })
                                const apartamentoTituloComponenteUI = this.reserva.categoriasGlobales.alojamiento.apartamentos.apartamentoTituloUI({
                                    apartamentoIDV: apartamentoIDV,
                                    apartamentoUID: apartamentoUID,
                                    apartamentoUI: apartamentoUI
                                })
                            ...
                            for (const detallesPernoctante of pernoctantes) {
                                ...
                                if (habitacionUID) {
                                    const selectorHabitacionUID = this.shadowRoot.querySelector(`[habitacionUID="${habitacionUID}"]`)
                            ...
                            this.reserva.categoriasGlobales.alojamiento.componentesUI.controlEspacioAlojamiento()
                        }
                    },
                    componentesUI: {
                        controlEspacioAlojamiento: () => {
                            const selectorMarcoalojamiento = this.shadowRoot.querySelector("[componente=marcoAlojamiento]")
                            const selectorApartamentos = this.shadowRoot.querySelectorAll("[componente=marcoAlojamiento] [apartamentoIDV]")
                            if (selectorApartamentos.length > 0) {
                                this.shadowRoot.querySelector("[componente=infoSinAlojamiento]")?.remove()
                            } else {
                    ...
                    habitaciones: {
                        ...
                        habitacionTituloUI: function (metadatos) {
                            ...
                            const reservaUI = this.shadowRoot.querySelector("[reservaUID]")
                        ...
                        selectorCambioHabitacionUI: function (pernoctanteUID) {
                            ...
                            selectorCambioHabitacionUI.addEventListener("click", (e) => {
                                this.reserva.categoriasGlobales.alojamiento.pernoctantes.cambiarDeHabitacion.cambiarPernoctanteHabitacion(pernoctanteUID, e)
                            })
                            return selectorCambioHabitacionUI
                            this.reserva.categoriasGlobales
                        },
                        propuestaEliminarHabitacionUI: function (datosEliminacion) {
                            ...
                            botonAceptar.addEventListener("click", () => {
                                ...
                                this.reserva.categoriasGlobales.alojamiento.habitaciones.eliminarHabitacion(datosEliminacion)
                            })
                            const botonCancelar = constructor.querySelector("[boton=cancelar]")
                        ...
                        opcionesHabitacion: async (data) => {
                            ...
                            const bannerReserva = this.reserva.categoriasGlobales.
                                alojamiento.
                                componentesUI.
                                bannerReservaMenus()
                            banner.appendChild(bannerReserva)
                            const bannerAlojamiento = this.reserva.categoriasGlobales.
                                alojamiento.
                                componentesUI.
                                bannerAlojamiento({
                                    apartamentoUI: apartamentoUI,
                            ...
                            const bannerHabitacion = this.reserva.categoriasGlobales.
                                alojamiento.
                                componentesUI.
                                bannerHabitacion({
                                    habitacionUI: habitacionUI,
                            ...
                            opcionAddPernoctante.addEventListener("click", () => {
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                this.reserva.categoriasGlobales.alojamiento.pernoctantes.gestionPernoctante.formularioNuevoPernoctanteEnHabitacionUI({
                                    habitacionUID,
                                    habitacionUI,
                                    apartamentoUI,
                                    habitacionIDV,
                            ...
                            opcionEliminarHabSinPernoc.addEventListener("click", () => {
                                this.reserva.categoriasGlobales.alojamiento.habitaciones.propuestaEliminarHabitacionUI({
                        ...
                        eliminarHabitacion: async function (datosElimiacion) {
                            ...
                            if (respuestaServidor?.ok) {
                                if (opcionPernoctantes === "eliminar") {
                                    this.shadowRoot.querySelector(`[habitacionUID="${habitacionUID}"]`)?.remove()
                                }
                                if (opcionPernoctantes === "conservar") {
                                    ...
                                    selectorPernoctantesHabitacion.forEach((pernoctanteSeleccionado) => {
                                        ...
                                        const bloquePernoctantes = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteUI(datosPernoctante)
                                        const datosNombre = {
                                            nombreCompleto: nombreCompleto,
                                        }
                                        const nombrePernoctante = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteNombreUI(datosNombre)
                                        bloquePernoctantes.appendChild(nombrePernoctante)
                                        const datosPasaporte = {
                                            pasaporte: pasaporte,
                                        }
                                        const identificacionPernoctante = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctantePasaporteUI(datosPasaporte)
                                        bloquePernoctantes.appendChild(identificacionPernoctante)
                                        if (this.shadowRoot.querySelector("[reservaUID]").getAttribute("reservaUID") === reservaUID) {
                                            const zonaDestino = this.shadowRoot.querySelector(`[componente=contenedorPernoctantesSinHabitacion]`)
                                            zonaDestino.appendChild(bloquePernoctantes)
                                        }
                                    })
                                    this.shadowRoot.querySelector(`[habitacionUID="${habitacionUID}"]`)?.remove()
                                }
                                this.reserva.categoriasGlobales.alojamiento.pernoctantes.controlEspacioPernoctantesSinAlojamiento()
                            }
                        },
                    },
                    apartamentos: {
                        ...
                        propuestaEliminarApartamentoUI: function (datosElimiacion) {
                            ...
                            botonAceptar.textContent = botonMenajeUI
                            botonAceptar.addEventListener("click", () => {
                                this.reserva.categoriasGlobales.alojamiento.apartamentos.eliminarApartamento({
                                    apartamentoUID: apartamentoUID,
                        ...
                        abrirMenuReservas: async () => {
                            ...
                            const fechaEntrada = this.shadowRoot.querySelector("[calendario=entrada]").getAttribute("memoriaVolatil")
                            const fechaSalida = this.shadowRoot.querySelector("[calendario=salida]").getAttribute("memoriaVolatil")
                            const transaccion = {
                                ...
                                if (apartamentosDisponibles.length > 0) {
                                    ...
                                    for (const detallesApartamento of apartamentosDisponibles) {
                                        ...
                                        apartamentoUI.addEventListener("click", (e) => {
                                            this.reserva.categoriasGlobales.alojamiento.apartamentos.anadirApartamento({
                        ...
                        opcionesApartamento: async function (apartamento) {
                            ...
                            contenedor.appendChild(banner)
                            const bannerReserva = this.reserva.categoriasGlobales.alojamiento.componentesUI.bannerReservaMenus()
                            banner.appendChild(bannerReserva)
                            const bannerAlojamiento = this.reserva.categoriasGlobales.
                                alojamiento.
                                componentesUI.
                            ...
                            const opcionesEliminacion = function (selector) {
                                if (selector === "sinBloqueo") {
                                    ...
                                    opcion.addEventListener("click", () => {
                                        ...
                                        this.reserva.categoriasGlobales.alojamiento.apartamentos.propuestaEliminarApartamentoUI({
                                            apartamentoUID: apartamentoUID,
                                            apartamentoUI: apartamentoUI,
                                ...
                                if (selector === "bloqueoPermanente") {
                                    ...
                                    opcion.addEventListener("click", () => {
                                        ...
                                        this.reserva.categoriasGlobales.alojamiento.apartamentos.propuestaEliminarApartamentoUI(datosPropuestaElimiacion)
                                    })
                                    return opcion
                                }
                                ...
                                if (habitacionesApartamento.length === 0) {
                                    ...
                                    habitacionesApartamento.forEach((habitacion) => {
                                        ...
                                        opcionApartamento.addEventListener("click", async () => {
                                            ...
                                            const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                                            const pantallaDeCargaRenderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_pantallaDeCarga}"]`)
                                            if (!pantallaDeCargaRenderizada) {
                                                return
                                            }
                                            pantallaDeCargaRenderizada?.remove()
                                            ...
                                            if (respuestaServidor?.ok) {
                                                const uiContenedor = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
                                                if (!uiContenedor) {
                                                    return
                                                }
                                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                                const bloqueHabitacionUI = this.reserva.categoriasGlobales.alojamiento.habitaciones.habitacionUI({
                                                    habitacionIDV: habitacion.habitacionIDV,
                                                    habitacionUID: respuestaServidor?.nuevoUID,
                                                    apartamentoIDV: apartamentoIDV
                                                })
                                                const nombreHabitacionUI = this.reserva.categoriasGlobales.alojamiento.habitaciones.habitacionTituloUI({
                                                    habitacionIDV: habitacion.habitacionIDV,
                                                    habitacionUID: respuestaServidor?.nuevoUID,
                                                    apartamentoIDV: apartamentoIDV,
                                                ...
                                                const camaComponenteUI = this.reserva.categoriasGlobales.alojamiento.camas.contenedorCamasUI({
                                                    habitacionIDV: habitacion.habitacionIDV,
                                                    apartamentoIDV: apartamentoIDV,
                                                    habitacionUID: respuestaServidor?.nuevoUID,
                                                    habitacionUI: habitacion.habitacionUI,
                                                ...
                                                this.shadowRoot.querySelector(`[apartamentoUID="${apartamentoUID}"]`).appendChild(bloqueHabitacionUI)
                                            }
                                        })
                                        contenedor.appendChild(opcionApartamento)
                                    })
                        ...
                        anadirApartamento: async (data) => {
                            ...
                            if (respuestaServidor?.ok) {
                                const uiContenedor = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUI_conteneodrUI}"]`)
                                if (!uiContenedor) {
                                    return
                                }
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                ...
                                const tituloApartamentoComponenteUI = this.reserva.categoriasGlobales.alojamiento.apartamentos.apartamentoTituloUI({
                                    apartamentoUI: respuestaServidor?.apartamentoUI
                                })
                                apartamentoComponenteUI.appendChild(tituloApartamentoComponenteUI)
                                this.shadowRoot.querySelector("[componente=espacioAlojamiento]").appendChild(apartamentoComponenteUI)
                                this.reserva.categoriasGlobales.alojamiento.componentesUI.controlEspacioAlojamiento()
                                this.reserva.reservaUI.actualizarReservaRenderizada()
                            }
                        },
                        eliminarApartamento: async function (metadatos) {
                            ...
                            if (respuestaServidor?.ok) {
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                const selectorPernoctantesHabitacion = this.shadowRoot.querySelectorAll(`[apartamentoUID="${apartamentoUID}"] [pernoctanteUID]`)
                                selectorPernoctantesHabitacion.forEach((pernoctanteSeleccionado) => {
                                    const nombreCompleto = pernoctanteSeleccionado.querySelector("[componente=nombreCompleto]").textContent
                                    const pasaporte = pernoctanteSeleccionado.querySelector("[componente=pasaporte]").textContent
                                    const tipoCliente = pernoctanteSeleccionado.getAttribute("tipoCliente")
                                    ...
                                    const fechaCheckIn = pernoctanteSeleccionado.getAttribute("fechaCheckIn")
                                    const fechaCheckOut = pernoctanteSeleccionado.getAttribute("fechaCheckOut")
                                    const bloquePernoctantes = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteUI({
                                        tipoPernoctante: tipoCliente,
                                        clienteUID: clienteUID,
                                        pernoctanteUID: pernoctanteUID,
                                        estadoAlojamiento: "noAlojado",
                                    ...
                                    const nombrePernoctante = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteNombreUI({
                                        nombreCompleto: nombreCompleto,
                                    })
                                    bloquePernoctantes.appendChild(nombrePernoctante)
                                    const identificacionPernoctante = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctantePasaporteUI({
                                        pasaporte: pasaporte,
                                    })
                                    bloquePernoctantes.appendChild(identificacionPernoctante)
                                    const zonaDestino = this.shadowRoot.querySelector(`[componente=contenedorPernoctantesSinHabitacion]`)
                                ...
                                casaVitini.shell.controladoresUI.ocultarMenusVolatiles()
                                this.shadowRoot.querySelector(`[apartamentoUID="${apartamentoUID}"]`).remove()
                                this.reserva.categoriasGlobales.alojamiento.componentesUI.controlEspacioAlojamiento()
                                this.reserva.categoriasGlobales.alojamiento.pernoctantes.controlEspacioPernoctantesSinAlojamiento()
                            }
                    ...
                    camas: {
                        ...
                        eliminarCamaFisica: {
                            ...
                            confirmar: async (data) => {
                                ...
                                this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_pantallaCarga}"]`)?.remove()
                                const instanciaRenderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_pantallaInmersia}"]`)
                            ...
                            if (respuestaServidor.ok) {
                                ...
                                respuestaServidor.listaCamasDisponiblesPorHabitacion.forEach(cama => {
                                    ...
                                    tipoCama.addEventListener("click", async () => {
                                        ...
                                        casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                        this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_localProceso}"]`)?.remove()
                                        if (respuestaServidor?.error) {
                                            casaVitini.shell.controladoresUI.limpiarTodoElementoFlotante()
                                            casaVitini.ui.componentes.advertenciaInmersiva(respuestaServidor?.error)
                                        }
                                        if (respuestaServidor?.ok) {
                                            ...
                                            const selectorTituloCama = this.shadowRoot.querySelector(`[habitacionUID="${habitacionUID}"] [contenedor=camas] [contenedor=camaCompartida]`)
                                    ...
                                    respuestaServidor.listaCamasFisicas.forEach(cama => {
                                        ...
                                        tipoCama.addEventListener("click", async () => {
                                            ...
                                            if (respuestaServidor?.ok) {
                                                ...
                                                const selectorContenedorCamas = this.shadowRoot.querySelector(`[habitacionUID="${habitacionUID}"] [contenedor=camas]`)
                                                ...
                                                if (!selectorContenedorCamasFisicasRenderizados) {
                                                    const contenedorCamasFisicasUI = this.reserva.categoriasGlobales.alojamiento.camas.contenedorCamasFisicas()
                                                ...
                                                const camaFisicaUI = this.reserva.categoriasGlobales.alojamiento.camas.camaFisicaUI({
                    ...
                    pernoctantes: {
                        ...
                        propuestaEliminarPernoctanteUI: function (datosEliminacion) {
                            ...
                            botonAceptar.addEventListener("click", () => {
                                ...
                                this.reserva.categoriasGlobales.alojamiento.pernoctantes.eliminarPernoctante(metadatosTipoEliminacion)
                            })
                            const botonCancelar = constructor.querySelector("[boton=cancelar]")
                            botonCancelar.textContent = "Cancelar la eliminación"
                            this.shadowRoot.appendChild(pantallaInmersiva)
                        ...
                        checkin: {
                            UI: async function (pernoctanteUID) {
                                ...
                                main.appendChild(ui)
                                const contenedor = ui.querySelector("[componente=contenedor]")
                                const pernoctanteElemento = this.shadowRoot.querySelector(`[pernoctanteUID="${pernoctanteUID}"]`)
                                ...
                                const pernoctanteUI = this.reserva.categoriasGlobales.alojamiento.pernoctantes.checkin.detallesDelTitularUI(datosTitular)
                                ...
                                botonCancelar.addEventListener("click", (e) => {
                                    ...
                                    this.reserva.categoriasGlobales.alojamiento.pernoctantes.checkin.confirmar(datosCheckIn)
                                }
                                )
                                contenedor.appendChild(botonCancelar)
                                ...
                                if (selectorCheckIn) {
                                    ...
                                    botonEliminarCheckIn.addEventListener("click", () => {
                                        ...
                                        this.reserva.categoriasGlobales.alojamiento.pernoctantes.checkin.eliminar(eliminarCheckIN)
                                    })
                            ...
                            confirmar: async function (checkIn) {
                                ...
                                const selectorPantallaDeCarga = this.shadowRoot.querySelectorAll(`[instanciaUID="${instanciaUID_localProceso}"][pantallaSuperpuesta=pantallaCargaSuperpuesta]`)
                                selectorPantallaDeCarga.forEach((pantalla) => {
                                    pantalla.remove()
                                })
                                const selectorInstanciaRaiz = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
                                ...
                                if (respuestaServidor?.ok) {
                                    casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                    const selectorPernoctante = this.shadowRoot.querySelector(`[pernoctanteUID="${pernoctanteUID}"]`)
                        ...
                        checkout: {
                            UI: async function (pernoctanteUID) {
                                ...
                                const pernoctanteUI = this.reserva.categoriasGlobales.alojamiento.pernoctantes.checkout.detallesDelTitularUI(datosTitular)
                                contenedor.appendChild(pernoctanteUI)
                                const instanciaUID_Calendario = casaVitini.utilidades.codigoFechaInstancia()
                                const metadatosCalendario = {
                                    tipoFecha: "salida",
                                ...
                                botonCancelar.addEventListener("click", (e) => {
                                    ...
                                    this.reserva.categoriasGlobales.alojamiento.pernoctantes.checkout.confirmar(datosCheckIn)
                                }
                                )
                                contenedor.appendChild(botonCancelar)
                                const infoEliminarReserva = document.createElement("div")
                                ...
                                if (selectorCheckOut) {
                                    ...
                                    botonEliminar.addEventListener("click", () => {
                                        ...
                                        this.reserva.categoriasGlobales.alojamiento.pernoctantes.checkout.eliminar(eliminarCheckOut)
                                    })
                        ...
                        detallesPernoctante: {
                            ui: async (data) => {
                                ...
                                const uiRenderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
                                if (!uiRenderizada) { return }
                                contenedor.innerHTML = null
                            ...
                            componentes: {
                                desasociarClienteComoTitular: async function (metadatos) {
                                    ...
                                    if (respuestaServidor?.ok) {
                                        ...
                                        const selectorDestinoRenderizado = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"] [espacio=gestionTitular]`)
                                        if (selectorDestinoRenderizado) {
                                        }
                                    }
                                },
                                ...
                                botonCambiarDeHabitacion: function (pernoctanteUID) {
                                    ...
                                    boton.addEventListener("click", () => {
                                        document.addEventListener("click", this.reserva.categoriasGlobales.alojamiento.pernoctantes.cambiarDeHabitacion.ocultarSelectoresCambioHabitacion)
                                        this.reserva.categoriasGlobales.alojamiento.pernoctantes.cambiarDeHabitacion.mostrasSelectorCambioPernoctanteHabitacion(pernoctanteUID)
                                    })
                                    return boton
                                },
                                ...
                                botonEliminarPernoctanteDeLaReserva: function (pernoctanteUID) {
                                    ...
                                    boton.addEventListener("click", () => {
                                        ...
                                        this.reserva.categoriasGlobales.alojamiento.pernoctantes.propuestaEliminarPernoctanteUI(datosEliminacion)
                                    })
                                    return boton
                                },
                                botonModificarCheckIn: function (pernoctanteUID) {
                                    ...
                                    boton.addEventListener("click", () => {
                                        this.reserva.categoriasGlobales.alojamiento.pernoctantes.checkin.UI(pernoctanteUID)
                                    })
                                    return boton
                                },
                                botonCheckOutAdelantado: function (pernoctanteUID) {
                                    ...
                                    boton.addEventListener("click", () => {
                                        this.reserva.categoriasGlobales.alojamiento.pernoctantes.checkout.UI(pernoctanteUID)
                                    })
                                    return boton
                                },
                                ...
                                botonCerrarCambiarTitular: function (instanciaUID) {
                                    ...
                                    boton.setAttribute("boton", "cerrarCambiarTitular")
                                    boton.addEventListener("click", () => {
                                        this.reserva.reservaUI.titular.componentes.cancelarCambiarTitular(instanciaUID)
                                    })
                                    return boton
                                },
                                cambiarTitular: function (instanciaUID) {
                                ...
                                respuestaUnificadaUI: (data) => {
                                    ...
                                    const habitacionUID = data.habitacionUID
                                    const ui = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`).querySelector("[componente=contenedor]")
                                    if (ui) {
                                        const selectorPernoctante = this.shadowRoot.querySelector(`[pernoctanteUID="${pernoctanteUID}"]`)
                                        ...
                                        const bannerReserva = this.reserva.categoriasGlobales.alojamiento.componentesUI.
                                            bannerReservaMenus()
                                        banner.appendChild(bannerReserva)
                                        const bannerAlojamiento = this.reserva.categoriasGlobales.
                                            alojamiento.
                        ...
                        cambiarDeHabitacion: {
                            mostrasSelectorCambioPernoctanteHabitacion: function (pernoctanteUID) {
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                const habitacionActual = this.shadowRoot.querySelector(`[pernoctanteUID="${pernoctanteUID}"]`)?.closest("[habitacionUID]")?.getAttribute("habitacionUID")
                                const selectorHabitaciones = this.shadowRoot.querySelectorAll("[habitacionIDV]")
                                const selectorBotonAsignarAHabitacionRenderizado = this.shadowRoot.querySelectorAll("[componente=botonMoverCliente]")
                                ...
                                selectorHabitaciones.forEach((habitacion) => {
                                    ...
                                    if (habitacionUID !== habitacionActual) {
                                        const bloqueSelectorCambio = this.reserva.categoriasGlobales.alojamiento.habitaciones.selectorCambioHabitacionUI(pernoctanteUID)
                            ...
                            ocultarSelectoresCambioHabitacion: function (e) {
                                ...
                                const selectorBotonMoverCliente = this.shadowRoot.querySelectorAll("[componente=botonMoverCliente]")
                                selectorBotonMoverCliente.forEach(selectorBotonMoverCliente => {
                                    selectorBotonMoverCliente.remove()
                                })
                                document.removeEventListener("click", this.reserva.categoriasGlobales.alojamiento.pernoctantes.cambiarDeHabitacion.ocultarSelectoresCambioHabitacion)
                            },
                            cambiarPernoctanteHabitacion: async function (pernoctanteUID, e) {
                                const reservaUID = this.reserva.data.reservaUID
                                const habitacionUID = e.target.closest("[habitacionUID]").getAttribute("habitacionUID")
                                const pernoctante = this.shadowRoot.querySelector(`[pernoctanteUID="${pernoctanteUID}"]`)
                                ...
                                this.shadowRoot.querySelectorAll("[componente=botonMoverCliente]").forEach(botonMover => {
                                    botonMover.remove()
                                })
                                this.shadowRoot.querySelectorAll("[componente=opcionesCliente]").forEach(opcionesCliente => {
                                ...
                                if (respuestaServidor?.ok) {
                                    this.shadowRoot.querySelector(`[pernoctanteUID="${pernoctanteUID}"]`)
                                        .remove()
                                    ...
                                    const bloqueClienteMover = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteUI(datoPernoctante)
                                    const datosNombre = {
                                        nombreCompleto: nombrePernoctante
                                    }
                                    const pernoctanteNombreUI = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteNombreUI(datosNombre)
                                    bloqueClienteMover.appendChild(pernoctanteNombreUI)
                                    const datosPasaporte = {
                                        pasaporte: pasaportePernoctante
                                    }
                                    const pernoctantePasaporteUI = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctantePasaporteUI(datosPasaporte)
                                    bloqueClienteMover.appendChild(pernoctantePasaporteUI)
                                    const selectorHabitacionDestino = this.shadowRoot.querySelector(`[habitacionUID="${habitacionUID}"]`)
                        ...
                        eliminarPernoctante: async function (metadatos) {
                            ...
                            casaVitini.ui.componentes.pantallaDeCargaSuperPuesta(metadatosPantallaCarga)
                            const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                            const selectorPantallaDeCarga = this.shadowRoot.querySelectorAll(`[instanciaUID="${instanciaUIDPantallaDeCarga}"][pantallaSuperpuesta=pantallaCargaSuperpuesta]`)
                            selectorPantallaDeCarga.forEach((pantalla) => {
                                pantalla.remove()
                            })
                            if (respuestaServidor?.error) {
                            ...
                            if (respuestaServidor?.ok) {
                                if (tipoEliminacion === "habitacion") {
                                    ...
                                    const bloquePernoctantes = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteUI(metadatosPernoctante)
                                    const metadatosNombre = {
                                        nombreCompleto: nombreCompleto,
                                        clienteUID: clienteUID,
                                    }
                                    const nombrePernoctante = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteNombreUI(metadatosNombre)
                                    bloquePernoctantes.appendChild(nombrePernoctante)
                                    const metadatosPasaporte = {
                                        pasaporte: pasaporte,
                                        clienteUID: clienteUID
                                    }
                                    const selectorPernoctanteRenderizado = this.shadowRoot.querySelector(`[pernoctanteUID="${pernoctanteUID}"]`)
                                    selectorPernoctanteRenderizado.remove()
                                    const identificacionPernoctante = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctantePasaporteUI(metadatosPasaporte)
                                    bloquePernoctantes.appendChild(identificacionPernoctante)
                                    const zonaDestino = this.shadowRoot.querySelector(`[componente=contenedorPernoctantesSinHabitacion]`)
                                    zonaDestino.appendChild(bloquePernoctantes)
                                    zonaDestino.classList.remove("elementoOcultoInicialmente")
                        ...
                        controlEspacioPernoctantesSinAlojamiento: () => {
                            const selectorMarcoPernoctantesSinAlojamiento = this.shadowRoot.querySelector("[componente=espacioPernoctantesSinAlojamiento]")
                        ...
                        gestionPernoctante: {
                            formularioNuevoPernoctanteEnHabitacionUI: async (data) => {
                                const habitacionIDV = data.habitacionIDV
                                const apartamentoIDV = data.apartamentoIDV
                                const habitacionUID = data.habitacionUID
                                const habitacionUI = data.habitacionUI
                            ...
                            componentes: {
                                buscadorRapido: {
                                    ...
                                    listaResultadosUI: async (data) => {
                                        ...
                                        const listaResultados_r = this.shadowRoot.querySelector("[componente=buscadorRapidoCliente]")
                                    ...
                                    transactor: async (data) => {
                                        ...
                                        const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                                        const listaBuscadorRenderizada = this.shadowRoot.querySelector(`[instanciaUIDBuscador="${instanciaUIDBuscador}"]`)
                                    ...
                                    anadirPernoctanteTransaccionDesdeBuscadorRapido: async (data) => {
                                        ...
                                        const selectorPantallaDeCarga = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDPantallaDeCarga}"]`)
                                        selectorPantallaDeCarga?.remove()
                                        const selectorBloqueAnadirPernoctante = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
                                        ...
                                        if (respuestaServidor?.ok) {
                                            ...
                                            bloquePernoctantes.appendChild(identificacionPernoctante)
                                            const habitacionDestino = this.shadowRoot.querySelector(`[habitacionUID="${habitacionUID}"]`)
                                ...
                                guardarNuevoClienteYSustituirloPorElClientePoolActual: async function (instanciaUID) {
                                    const pernoctanteUID_DesdeInstancia = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`).getAttribute("pernoctanteUID")
                                    const instanciaUID_pantallaPropuestaConfirmada = casaVitini.utilidades.codigoFechaInstancia()
                                    const reservaUID = this.reserva.data.reservaUID
                                    const campos = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"] [formulario=nuevoCliente]`).querySelectorAll("[campo]")
                                    const metadatosPantallaCarga = {
                                        mensaje: "Esperando al servidor...",
                                        instanciaUID: instanciaUID_pantallaPropuestaConfirmada,
                                    }
                                    casaVitini.ui.componentes.pantallaDeCargaSuperPuesta(metadatosPantallaCarga)
                                    const selectorPantallaDeCarga = this.shadowRoot.querySelectorAll(`[instanciaUID="${instanciaUID_pantallaPropuestaConfirmada}"]`)
                                    const transaccion = {
                                    ...
                                    if (respuestaServidor?.ok) {
                                        ...
                                        const selectorInstanciaRaiz = this.shadowRoot.querySelectorAll(`[instanciaUID="${instanciaUID}"]`)
                                        selectorInstanciaRaiz.forEach((pantalla) => {
                                            pantalla.remove()
                                        })
                                        const selectorContenedorPernoctanteAntiguo = this.shadowRoot.querySelector(`[contenedor=pernoctante][pernoctanteUID="${pernoctanteUID_DesdeInstancia}"]`)
                                        selectorContenedorPernoctanteAntiguo.remove()
                                        if (habitacionUID) {
                                            const selectorHabitacion = this.shadowRoot.querySelector(`[habitacionUID="${habitacionUID}"]`)
                                            let metadatos = {
                                                tipoPernoctante: "cliente",
                                            ...
                                            const bloquePernoctantes = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteUI(metadatos)
                                            metadatos = {
                                                nombreCompleto: nombreCompleto,
                                            }
                                            const nombrePernoctante = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteNombreUI(metadatos)
                                            bloquePernoctantes.appendChild(nombrePernoctante)
                                            metadatos = {
                                                pasaporte: pasaporte,
                                            }
                                            const identificacionPernoctante = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctantePasaporteUI(metadatos)
                                            bloquePernoctantes.appendChild(identificacionPernoctante)
                                            ...
                                            const bloquePernoctantes = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteUI(metadatosBloquePernoctantes)
                                            const metadatosNombreUi = {
                                                nombreCompleto: nombreCompleto,
                                            }
                                            const nombrePernoctante = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteNombreUI(metadatosNombreUi)
                                            bloquePernoctantes.appendChild(nombrePernoctante)
                                            const metadatosPasaporte = {
                                                pasaporte: pasaporte,
                                            }
                                ...
                                guardarNuevoClienteYAnadirloComoPernoctnante: async (data) => {
                                    ...
                                    if (respuestaServidor?.ok) {
                                        const selectorAnadirPernoctanteRedenrizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_contenedorNuevoPernoctanteUI}"]`)
                                        ...
                                        const pernoctanteUI = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteUI({
                                            tipoPernoctante: "cliente",
                                            clienteUID: respuestaServidor?.nuevoUIDCliente,
                                            pernoctanteUID: respuestaServidor?.nuevoUIDPernoctante,
                                            estadoAlojamiento: "alojado"
                                        })
                                        const pernoctanteNombreUI = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctanteNombreUI({
                                            clienteUID: respuestaServidor?.nuevoUIDCliente,
                                            nombreCompleto: `${nombre} ${primerApellido} ${segundoApellido}`
                                        })
                                        const pernoctantePasaporteUI = this.reserva.categoriasGlobales.alojamiento.pernoctantes.pernoctantePasaporteUI({
                                            clienteUID: respuestaServidor?.nuevoUIDCliente,
                ...
                complementosDeAlojamiento: {
                    arranque: async () => {
                        ...
                        const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                        const instanciaDestino = this.shadowRoot.querySelector(`[componente=complementosDeAlojamiento][instanciaUID="${instanciaUID_contenedorComplementos}"]`)
                        if (!instanciaDestino) { return }
                        instanciaDestino.innerHTML = null
                        if (respuestaServidor?.error) {
                            const errorUI = document.createElement("p")
                        ...
                        if (respuestaServidor?.ok) {
                            ...
                            boton.addEventListener("click", () => {
                                this.reserva.reservaUI.ui.componentesUI.insertarServicio.ui({
                            ...
                            const apartamentoUI = (data) => {
                                ...
                                if (configuracionVista === "administrativa") {
                                    ...
                                    b.addEventListener("click", () => {
                                        this.reserva.reservaUI.ui.componentesUI.insertarComplementoEnAlojamiento.ui({
                                ...
                                c.appendChild(this.reserva.categoriasGlobales.complementosDeAlojamiento.componentesUI.infoSinComplemento())
                                ui.appendChild(c)
                                return ui
                            }
                            ...
                            complementosDeAlojamiento.forEach((com) => {
                                ...
                                contenedor.appendChild(this.reserva.reservaUI.ui.componentesUI.complementoUI(com))
                            })
                            return
                            ...
                            if (serviciosEnReserva.length === 0) {
                                ...
                                const infoSinEnlaces = this.reserva.reservaUI.ui.componentesUI.infoSinServiciosUI()
                            ...
                            if (serviciosEnReserva.length > 0) {
                                ...
                                for (const servicioEnReserva of serviciosEnReserva) {
                                    const servicioUI = this.reserva.reservaUI.ui.componentesUI.servicioUI({
                    ...
                    componentesUI: {
                        insertarComplementoEnAlojamiento: {
                            ui: async (data) => {
                                ...
                                const uiRenderizada = this.shadowRoot.querySelectorAll(`[instanciaUID="${instanciaUID_contenedorComplementos}"]`)
                                if (!uiRenderizada) { return }
                                if (respuestaServidor?.error) {
                                    casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                    return casaVitini.ui.componentes.advertenciaInmersiva(respuestaServidor?.error)
                            ...
                            confirmarInsertar: async (data) => {
                                ...
                                const instanciaUID_contenedorComplementos = data.instanciaUID_contenedorComplementos
                                const ui = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_insertarComplementoUI}"]`)
                                const contenedor = ui.querySelector("[componente=contenedor]")
                                contenedor.innerHTML = null
                                const spinner = casaVitini.ui.componentes.spinner({
                                ...
                                const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                                const uiRenderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_contenedorComplementos}"]`)
                                if (!uiRenderizada) { return }
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                if (respuestaServidor?.error) {
                                    return casaVitini.ui.componentes.advertenciaInmersiva(respuestaServidor?.error)
                                ...
                                if (respuestaServidor?.ok) {
                                    ...
                                    const complementoUI = this.reserva.categoriasGlobales.complementosDeAlojamiento.componentesUI.complementoUI({
                        ...
                        eliminarComplementoDeAlojamiento: {
                            ...
                            confirmarEliminar: async (data) => {
                                ...
                                const instanciaUID_contenedorComplementosDeAlojamiento = data.instanciaUID_contenedorComplementosDeAlojamiento
                                const ui = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_eliminarServicio}"]`)
                                const contenedor = ui.querySelector("[componente=constructor]")
                                contenedor.innerHTML = null
                                const spinner = casaVitini.ui.componentes.spinner({
                                ...
                                if (respuestaServidor?.ok) {
                                    this.reserva.reservaUI.actualizarReservaRenderizada()
                                    const selectorContenedor = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_contenedorComplementosDeAlojamiento}"] [apartamentoIDV="${apartamentoIDV}"] [contenedor=complementos]`)
                                    if (!selectorContenedor) {
                                        return
                                    }
                                    casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                    ...
                                    if (selectorContenedoresDeServiciosRenderizados.length === 0) {
                                        const infoSinEnlaces = this.reserva.categoriasGlobales.complementosDeAlojamiento.componentesUI.infoSinComplemento()
                        ...
                        complementoUI: (data) => {
                            ...
                            if (configuracionVista === "administrativa") {
                                ...
                                b.addEventListener("click", (e) => {
                                    ...
                                    this.reserva.categoriasGlobales.complementosDeAlojamiento.componentesUI.eliminarComplementoDeAlojamiento.ui({
                                        complementoUI,
                                        instanciaUID_contenedorComplementosDeAlojamiento,
                ...
                enlacesDePago: {
                    arranque: async (e) => {
                        ...
                        const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                        const instanciaDestino = this.shadowRoot.querySelector(`[componente=categoriaEnlacesDePago][instanciaUID="${instanciaUID}"]`)
                        if (!instanciaDestino) { return }
                        instanciaDestino.innerHTML = null
                        if (respuestaServidor?.error) {
                            const errorUI = document.createElement("p")
                        ...
                        if (respuestaServidor?.ok) {
                            ...
                            botonCrearPagoManual.addEventListener("click", () => {
                                this.reserva.categoriasGlobales.enlacesDePago.crearEnlace.UI(instanciaUID)
                            })
                            ...
                            if (enlacesDePagoGenerados.length === 0) {
                                ...
                                for (const detallesDelEnlace of enlacesDePagoGenerados) {
                                    const enlaceUI = this.reserva.categoriasGlobales.enlacesDePago.enlaceUI({
                    ...
                    eliminarEnlace: {
                        UI: async function (datosElimiacion) {
                            ...
                            botonCancelar.addEventListener("click", () => {
                                this.reserva.categoriasGlobales.enlacesDePago.eliminarEnlace.confirmar({
                                    enlaceUID,
                                    instanciaUID
                                })
                            })
                            ...
                            botonVolverAlEnlace.addEventListener("click", this.reserva.categoriasGlobales.enlacesDePago.desplegarUI)
                            const botonCancelarProcesoCancelacion = document.createElement("div")
                            ...
                            this.shadowRoot.appendChild(advertenciaInmersivaIU)
                        },
                        confirmar: async function (datosElimiacion) {
                            ...
                            const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                            const instanciaRenderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_pantallaCarga}"]`)
                            if (!instanciaRenderizada) { return }
                            instanciaRenderizada.remove()
                            if (respuestaServidor?.error) {
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                            ...
                            if (respuestaServidor?.ok) {
                                const contenedorEspacioEnlacesDePago = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
                                this.shadowRoot.querySelector(`[enlacePagoUID="${enlaceUID}"]`)?.remove()
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                    ...
                    crearEnlace: {
                        ...
                        Genera un enlace de pago para poder enviarlo a un cliente y que realice el pago de la reserva. No es obligatorio escribir un nombre, pero sí recomendable, por si necesita acordarse de por qué genera este enlace. Si no define ningún nombre, este se llamará "Enlace de pago de la reserva ${reservaUID}". Este es el nombre automático que tendrá este enlace si no define un nombre en específico. Recuerde que todos los enlaces generados y su gestión centralizada la puede encontrar en el panel de administración, en el botón de Enlaces de pago desde el menú administración o en su reserva correspondiente dentro del apartado enlaces de pago.`
                            ...
                            botonConfirmar.addEventListener("click", () => {
                                this.reserva.categoriasGlobales.enlacesDePago.crearEnlace.confirmar(instanciaUID)
                            })
                        ...
                        confirmar: async function (instanciaUID) {
                            ...
                            casaVitini.ui.componentes.pantallaDeCargaSuperPuesta(datosPantallaSuperpuesta)
                            const reservaUID = this.reserva.data.reservaUID
                            const nombreEnlace = this.shadowRoot.querySelector("[espacio=formularioCrearEnlaceDePago] [campo=nombreEnlace]")
                            const cantidad = this.shadowRoot.querySelector("[espacio=formularioCrearEnlaceDePago] [campo=cantidad]")
                            const horasCaducidad = this.shadowRoot.querySelector("[espacio=formularioCrearEnlaceDePago] [campo=horasCaducidad]")
                            const transaccion = {
                            ...
                            if (respuestaServidor?.ok) {
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                const seleccionarInstancia = this.shadowRoot.querySelector(`[componente=categoriaEnlacesDePago][instanciaUID="${instanciaUID}"] [componente=contenedorListaEnlacesDePago]`)
                                if (seleccionarInstancia) {
                                    ...
                                    const enlaceUI = this.reserva.categoriasGlobales.enlacesDePago.enlaceUI(metadatos)
                                    const primerElemento = seleccionarInstancia.firstChild;
                                    seleccionarInstancia.insertBefore(enlaceUI, primerElemento);
                                    this.shadowRoot.querySelector("[componente=contenedorInfoSinEnlaces]")?.remove()
                                }
                            }
                        }
                    },
                    acutalizarEnlace: async () => {
                        const botonActualizar = this.shadowRoot.querySelector("[componente=botonActualizarEnlace]")
                        const reservaUID = this.reserva.data.reservaUID
                        const nombreEnlace = this.shadowRoot.querySelector("[campo=nombreEnlace]")
                        const descripcion = this.shadowRoot.querySelector("[campo=descripcion]")
                        ...
                        const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                        if (respuestaServidor?.error) {
                            const advertenciasInmersivasRenderizadas = this.shadowRoot.querySelectorAll("[componente=advertenciaInmersiva]")
                    ...
                    enlaceUI: function (metadatos) {
                        ...
                        botonEliminar.addEventListener("click", () => {
                            ...
                            this.reserva.categoriasGlobales.enlacesDePago.eliminarEnlace.UI(datosElimiacion)
                        })
                        contenedorBotones.appendChild(botonEliminar)
                ...
                transacciones: {
                    arranque: async () => {
                        ...
                        const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                        const instanciaDestino = this.shadowRoot.querySelector(`[contenedorID=transacciones][instanciaUID="${instanciaUID_contenedorDinamicoTransacciones}"]`)
                        if (!instanciaDestino) { return }
                        instanciaDestino.innerHTML = null
                        if (respuestaServidor?.error) {
                            const errorUI = document.createElement("p")
                        ...
                        if (respuestaServidor?.ok) {
                            instanciaDestino.style.justifyContent = "flex - start";
                            this.reserva.categoriasGlobales.transacciones.UI.listaDePagos({
                    ...
                    UI: {
                        listaDePagos: async (data) => {
                            ...
                            botonEnlacesDePago.addEventListener("click", this.reserva.categoriasGlobales.transacciones.UI.enlacesDePago)
                            botonEnlacesDePago.textContent = "Crear un enlace de pago"
                            const botonCrearPagoManual = document.createElement("div")
                            botonCrearPagoManual.classList.add("botonV1BlancoIzquierda")
                            botonCrearPagoManual.addEventListener("click", () => {
                                this.reserva.categoriasGlobales.transacciones.crearPagoManual.UI()
                            })
                            ...
                            if (pagos.length === 0) {
                                const infoNoPagoUI = this.reserva.categoriasGlobales.transacciones.UI.infoNoPagos()
                            ...
                            if (pagos.length > 0) {
                                ...
                                for (const detallesDelPago of pagos) {
                                    const pagoUI = this.reserva.categoriasGlobales.transacciones.UI.pagoUI(detallesDelPago)
                                    bloqueListaDePagos.appendChild(pagoUI)
                                }
                                bloqueTransacciones.appendChild(bloqueListaDePagos)
                            }
                            const enlacePagoUIRenderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_contenedorDinamicoTransacciones}"]`)
                        ...
                        pagoUI: function (metadatos) {
                            ...
                            bloqueDetallesDelPago.addEventListener("click", () => {
                                ...
                                this.reserva.categoriasGlobales.transacciones.detallesDelPago.UI(metadatos)
                            })
                            let bloqueInfoDato = document.createElement("div")
                    ...
                    detallesDelPago: {
                        UI: async function (metadatos) {
                            ...
                            this.shadowRoot.appendChild(advertenciaInmersivaIU)
                            const ocultaPanales = () => {
                                const selectorContenedores = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"]`)
                            ...
                            if (respuestaServidor?.ok) {
                                ...
                                const selectorInstanciaRenderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"]`)?.querySelector("[espacio=detallesDelPago]")
                                ...
                                botonCrearReembolso.addEventListener("click", () => {
                                    ocultaPanales()
                                    const selectorContenedorReembolso = this.shadowRoot.querySelector("[contenedor=nuevoReembolso]")
                                    ...
                                    this.reserva.categoriasGlobales.transacciones.reembolsos.reembolsoUI(metadatos)
                                })
                                ...
                                botonEliminarPago.addEventListener("click", () => {
                                    ocultaPanales()
                                    const selectorContenedorEliminarPago = this.shadowRoot.querySelector("[contenedor=eliminarPago]")
                                    selectorContenedorEliminarPago.innerHTML = null
                                    const metadatos = {
                                        instanciaUIDDetalleDelPago: instanciaUIDDetalleDelPago
                                    }
                                    const eliminarPagoUI = this.reserva.categoriasGlobales.transacciones.eliminarPagoManual.UI(metadatos)
                                ...
                                const restaurarTodasLasOpcionesDeTodosLosReembolsos = (pagoUID, instanciaUIDDetalleDelPago) => {
                                    const reembolsosOpcionesDesplegadas = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"]`)?.querySelectorAll("[contenedor=opcionesDelReembolso][estado=opcionesDesplegadas]")
                                ...
                                const opcionesReembolsoUI = (metadatos) => {
                                    ...
                                    const selectorReembolso = this.shadowRoot.querySelector(`[reembolsoUID="${reembolsoUID}"]`).querySelector("[contenedor=opcionesDelReembolso]")
                                    ...
                                    botonEliminarReembolso.addEventListener("click", () => {
                                        ...
                                        this.reserva.categoriasGlobales.transacciones.reembolsos.eliminarReembolso(metadatosEliminarReembolso)
                                    })
                        ...
                        confirmar: async () => {
                            ...
                            if (respuestaServidor?.ok) {
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                this.reserva.categoriasGlobales.transacciones.UI.enlacesDePago()
                            }
                        }
                    },
                    reembolsos: {
                        reembolsoUI: async function (metadatos) {
                            ...
                            const instanciaUID_contenedorDinamicoTransacciones = metadatos.instanciaUID_contenedorDinamicoTransacciones
                            const instanciaUIDDetalleDelPago = metadatos.instanciaUIDDetalleDelPago
                            const selectorContenedorCrearReembolso = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [contenedor=nuevoReembolso]`)
                            ...
                            const maximoReembolsable = async () => {
                                const totalPagado = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [cantidadPago]`).getAttribute("cantidadPago")
                                const totalReembolsado = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [sumaDeLoReembolsado]`)?.getAttribute("sumaDeLoReembolsado")
                                const selectorUI = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [componente=totalReembolsable]`)
                            ...
                            const reglaDeTresPorcentaje = async (porcentaje) => {
                                ...
                                const selectorTotalReembolsableConReeembolsos = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [totalReembolsable]`)
                                if (selectorTotalReembolsableConReeembolsos) {
                                    ...
                                    const selectorTotalReembolsableSinReembolsos = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [cantidadPago]`).getAttribute("cantidadPago")
                                    totalReembolsable = selectorTotalReembolsableSinReembolsos
                                }
                                const selectorUI = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [informacionPorcentaje=informacionPorcentaje]`)
                            ...
                            campoPorcentajeReembolso.addEventListener("input", (e) => {
                                ...
                                const selectorInformacionResultadoPorcentaje = this.shadowRoot.querySelector("[informacionPorcentaje=informacionPorcentaje]")
                            ...
                            botonConfirmar.addEventListener("click", () => {
                                this.reserva.categoriasGlobales.transacciones.reembolsos.confirmarReembolso({
                                    pagoUID: pagoUID,
                                    instanciaUID_contenedorDinamicoTransacciones: instanciaUID_contenedorDinamicoTransacciones,
                                    instanciaUIDDetalleDelPago: instanciaUIDDetalleDelPago
                                })
                        ...
                        eliminarReembolso: async function (metadatos) {
                            ...
                            casaVitini.ui.componentes.pantallaDeCargaSuperPuesta(metadatosPantallaCarga)
                            const pagoUID = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"]`).querySelector("[pagoUID]").getAttribute("pagoUID")
                            const palabra = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"]`).querySelector(`[reembolsoUID="${reembolsoUID}"] [campo=palabra]`).value
                            const transaccion = {
                            ...
                            const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                            const selectorPantallaDeCarga = this.shadowRoot.querySelectorAll(`[instanciaUID="${instanciaUIDDetalleDelPago}"][pantallaSuperpuesta=pantallaCargaSuperpuesta]`)
                            selectorPantallaDeCarga.forEach((pantalla) => {
                                pantalla.remove()
                            })
                            if (respuestaServidor?.error) {
                            ...
                            if (respuestaServidor?.ok) {
                                const selectorDetallesDelPagoRenderizado = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"]`)
                                if (selectorDetallesDelPagoRenderizado) {
                                    //  this.reserva.categoriasGlobales.transacciones.arranque()
                                    this.reserva.reservaUI.ui.componentesUI.categoriasGlobalesUI.controladorCategorias({
                                        categoria: "transacciones",
                                        origen: "url",
                                        reservaUID: reservaUID
                        ...
                        confirmarReembolso: async function (metadatos) {
                            ...
                            const instanciaUID_pantallaDeCarga = casaVitini.utilidades.codigoFechaInstancia()
                            const reservaUID = this.reserva.data.reservaUID
                            const tipoReembolso = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [tipoReembolsoSeleccionado]`)?.getAttribute("tipoReembolsoSeleccionado")
                            const metadatosPantallaCarga = {
                                mensaje: "Esperando al servidor...",
                                instanciaUID: instanciaUID_pantallaDeCarga,
                            }
                            ...
                            if (tipoReembolso === "porPorcentaje") {
                                const cantidad = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [contenedortiporeembolso=porPorcentaje] [totalReembolso]`)?.getAttribute("totalReembolso")
                                transaccion.cantidad = cantidad
                            }
                            if (tipoReembolso === "porCantidad") {
                                const cantidad = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [contenedortiporeembolso=porCantidad] [campo=porCantidad]`)?.value
                                transaccion.cantidad = cantidad
                            }
                            transaccion.tipoReembolso = tipoReembolso
                            const plataformaDePagoEntrada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [contenedor=nuevoReembolso] [campo=plataformaDePagoEntrada]`).value
                            transaccion.plataformaDePagoEntrada = plataformaDePagoEntrada
                            if (tipoReembolso === "pasarela") {
                                const palabra = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"] [campo=palabra]`)?.value
                                transaccion.palabra = palabra
                            }
                            const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                            const selectorPantallaDeCarga = this.shadowRoot.querySelectorAll(`[instanciaUID="${instanciaUID_pantallaDeCarga}"][pantallaSuperpuesta=pantallaCargaSuperpuesta]`)
                            selectorPantallaDeCarga.forEach((pantalla) => {
                                pantalla.remove()
                            })
                            if (respuestaServidor?.error) {
                            ...
                            if (respuestaServidor?.ok) {
                                ...
                                casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                this.reserva.categoriasGlobales.transacciones.detallesDelPago.UI({
                                    pagoUID: pagoUID,
                                    instanciaUID_contenedorDinamicoTransacciones: instanciaUID_contenedorDinamicoTransacciones
                                })
                            }
                    ...
                    crearPagoManual: {
                        UI: () => {
                            const mostrarContenedorTipoPago = (opcion) => {
                                const selectorInfo = this.shadowRoot.querySelector("[componente=advertenciaInmersiva] [componente=infoDesplegable]")
                                selectorInfo?.remove()
                                const selectorTodosLosContenedorTipoPago = this.shadowRoot.querySelectorAll(`[componente=advertenciaInmersiva] [contenedorTipoPago]`)
                                ...
                                const selectorContenedorTipoPago = this.shadowRoot.querySelector(`[componente=advertenciaInmersiva] [contenedorTipoPago=${tipoPago}]`)
                            ...
                            const contenedorEfectivo = this.reserva.categoriasGlobales.transacciones.crearPagoManual.contenedoresTipoPago.efectivo()
                            contenedorTipoPago.appendChild(contenedorEfectivo)
                            const contenedorCheque = this.reserva.categoriasGlobales.transacciones.crearPagoManual.contenedoresTipoPago.cheque()
                            contenedorTipoPago.appendChild(contenedorCheque)
                            const contenedorTransferenciaBancaria = this.reserva.categoriasGlobales.transacciones.crearPagoManual.contenedoresTipoPago.transferenciaBancaria()
                            contenedorTipoPago.appendChild(contenedorTransferenciaBancaria)
                            const contenedorTarjeta = this.reserva.categoriasGlobales.transacciones.crearPagoManual.contenedoresTipoPago.tarjeta()
                            contenedorTipoPago.appendChild(contenedorTarjeta)
                            const contenedorPasarela = this.reserva.categoriasGlobales.transacciones.crearPagoManual.contenedoresTipoPago.pasarela()
                            ...
                            botonConfirmar.addEventListener("click", () => {
                                this.reserva.categoriasGlobales.transacciones.crearPagoManual.confirmar()
                            })
                            bloqueBotones.appendChild(botonConfirmar)
                            const botonCancelar = document.createElement("div")
                            botonCancelar.classList.add("botonV1")
                        ...
                        confirmar: async () => {
                            const instanciaUID_contenedorDinamicoTransacciones = this.shadowRoot.querySelector("[contenedorID=transacciones]").getAttribute("instanciaUID")
                            const reservaUID = this.reserva.data.reservaUID
                            const contenedorActivo = this.shadowRoot.querySelector("[estado=activa][contenedorTipoPago]")
                            const plataformaDePago = this.shadowRoot.querySelector("[campo=selectorRol]").value
                            ...
                            const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                            const selectorPantallaDeCarga = this.shadowRoot.querySelectorAll(`[instanciaUID="${instanciaUID_pantallaEspera}"][pantallaSuperpuesta=pantallaCargaSuperpuesta]`)
                            selectorPantallaDeCarga.forEach((pantalla) => {
                                pantalla.remove()
                            })
                            if (respuestaServidor?.error) {
                            ...
                            if (respuestaServidor?.ok) {
                                const seleccionarInstancia = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_contenedorDinamicoTransacciones}"]`)
                                if (seleccionarInstancia) {
                                    const datosPagosGlobal = {
                                        reservaUID: reservaUID,
                                        instanciaUID_contenedorDinamicoTransacciones: instanciaUID_contenedorDinamicoTransacciones
                                    }
                                    this.reserva.categoriasGlobales.transacciones.actualizarDatosGlobalesPago(datosPagosGlobal)
                                    casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                    ...
                                    const detallesDelPago = respuestaServidor.detallesDelPago
                                    const enlaceUI = this.reserva.categoriasGlobales.transacciones.UI.pagoUI(detallesDelPago)
                    ...
                    eliminarPagoManual: {
                        UI: function (metadatos) {
                            ...
                            botonConfirmar.addEventListener("click", () => {
                                ...
                                this.reserva.categoriasGlobales.transacciones.eliminarPagoManual.confirmar(metadatos)
                            })
                        ...
                        confirmar: async function (metadatos) {
                            ...
                            casaVitini.ui.componentes.pantallaDeCargaSuperPuesta(metadatosPantallaCarga)
                            const pagoUID = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"]`).querySelector("[pagoUID]").getAttribute("pagoUID")
                            const palabra = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"]`).querySelector("[contenedor=eliminarPago] [campo=palabra]").value
                            const instanciaUID_contenedorDinamicoTransacciones = this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"] [contenedorID=transacciones]`).getAttribute("instanciaUID")
                            const transaccion = {
                            ...
                            if (respuestaServidor?.ok) {
                                ...
                                this.reserva.categoriasGlobales.transacciones.actualizarDatosGlobalesPago(datosActualizar)
                                document.body.removeAttribute("style")
                                this.shadowRoot.querySelector(`[instanciaUID="${instanciaUIDDetalleDelPago}"]`)?.remove()
                                const contenedorTransacciones = this.shadowRoot.querySelector(`[contenedorID=transacciones][instanciaUID="${instanciaUID_contenedorDinamicoTransacciones}"]`)
                    ...
                    actualizarDatosGlobalesPago: async function (metadatos) {
                        const reservaUID = metadatos.reservaUID
                        const instanciaUID_contenedorDinamicoTransacciones = this.shadowRoot.querySelector("[contenedorID=transacciones]").getAttribute("instanciaUID")
                        const selectorTotalReservaEnPanelGlobal = this.shadowRoot.querySelector(`[dataReserva=totalReservaConImpuestos]`)
                        const selectorTotalReserva = this.shadowRoot.querySelector(`[componentePago=totalReserva]`)
                        const selectorTotalPagado = this.shadowRoot.querySelector(`[componentePago=totalPagado]`)
                        const selectorFaltantePorPagar = this.shadowRoot.querySelector(`[componentePago=faltantePorPagar]`)
                        const selectorEstadoPago = this.shadowRoot.querySelector(`[dataReserva=estadoPago]`)
                        const selectorPorecentajeReembolsado = this.shadowRoot.querySelector(`[componentePago=porcentajeReembolsado]`)
                        const selectorPorecentajePagado = this.shadowRoot.querySelector(`[componentePago=porcentajePagado]`)
                        const selectorTotalReembolsado = this.shadowRoot.querySelector(`[componentePago=totalReembolsado]`)
                        const reservaAcutalRenderizada = this.shadowRoot.querySelector("[reservaUID]").getAttribute("reservaUID")
                ...
                servicios: {
                    arranque: async (e) => {
                        ...
                        const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                        const instanciaDestino = this.shadowRoot.querySelector(`[componente=categoriaServicios][instanciaUID="${instanciaUID_contenedorServicios}"]`)
                        if (!instanciaDestino) { return }
                        instanciaDestino.innerHTML = null
                        if (respuestaServidor?.error) {
                            const errorUI = document.createElement("p")
                        ...
                        if (respuestaServidor?.ok) {
                            ...
                            if (serviciosEnReserva.length === 0) {
                                ...
                                const infoSinEnlaces = this.reserva.categoriasGlobales.servicios.componentesUI.infoSinServiciosUI()
                                instanciaDestino.appendChild(infoSinEnlaces)
                            }
                            if (serviciosEnReserva.length > 0) {
                    ...
                    componentesUI: {
                        acutalizarServicioEnReserva: {
                            ui: async (data) => {
                                ...
                                const ui_enEspera = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_UIFlotanteServicios}"]`)
                            ...
                            confirmarActualizar: async (data) => {
                                const reservaUID = this.reserva.data.reservaUID
                                ...
                                this.shadowRoot.querySelector(`[instanciaUID="${instanciaPantallaCarga}"]`).remove()
                                if (respuestaServidor?.error) {
                                    return casaVitini.ui.componentes.advertenciaInmersivaSuperPuesta(respuestaServidor?.error)
                                }
                                if (respuestaServidor?.ok) {
                                    ...
                                    this.reserva.reservaUI.actualizarReservaRenderizada()
                                    const selectorContenedorServicios = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_contenedorServicios}"]`)
                                    if (!selectorContenedorServicios) {
                                        return
                                    }
                                    const servicioUI = this.reserva.categoriasGlobales.servicios.componentesUI.servicioUI({
                        ...
                        insertarServicio: {
                            ...
                            despliegeListaServicios: async (data) => {
                                const ui = data.ui
                                const instanciaUID_UIFlotanteServicios = data.instanciaUID_UIFlotanteServicios
                                const instanciaUID_contenedorServicios = data.instanciaUID_contenedorServicios
                                const reservaUID = this.reserva.data.reservaUID
                                ...
                                const uiRenderizada = this.shadowRoot.querySelectorAll(`[instanciaUID="${instanciaUID_UIFlotanteServicios}"]`)
                                if (!uiRenderizada) { return }
                                if (respuestaServidor?.error) {
                                    casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                    return casaVitini.ui.componentes.advertenciaInmersiva(respuestaServidor?.error)
                            ...
                            despliegeDeSeleccionEnServicio: async (data) => {
                                const reservaUID = this.reserva.data.reservaUID
                ...
                desgloseTotal: {
                    arranque: async () => {
                        const instanciaUID = casaVitini.utilidades.codigoFechaInstancia()
                        this.shadowRoot.querySelector(`[categoriaReserva=desgloseTotal]`).setAttribute("estadoCategoria", "actual")
                        ...
                        const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                        const instanciaDestino = this.shadowRoot.querySelector(`[componente=contenedorDesgloseTotal][instanciaUID="${instanciaUID}"]`)
                        if (!instanciaDestino) { return }
                        instanciaDestino.innerHTML = null
                        if (respuestaServidor?.error) {
                            const errorUI = document.createElement("p")
                        ...
                        if (respuestaServidor?.ok) {
                            ...
                            botonInsertarDescuento.addEventListener("click", () => {
                                this.reserva.reservaUI.ui.componentesUI.insertarDescuentos.ui({
                            ...
                            botonSobreControlDePrecios.addEventListener("click", () => {
                                this.reserva.reservaUI.ui.componentesUI.sobreControlPrecios.arranque()
                            })
                    ...
                    componentesUI: {
                        insertarDescuentos: {
                            ui: async (data) => {
                                ...
                                const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                                const uiRenderizada = this.shadowRoot.querySelectorAll(`[instanciaUID="${instanciaUID_insertarDescuentosUI}"]`)
                                if (!uiRenderizada) { return }
                                if (respuestaServidor?.error) {
                                    casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                    return casaVitini.ui.componentes.advertenciaInmersiva(respuestaServidor?.error)
                            ...
                            confirmarInsertar: async (data) => {
                                ...
                                const instanciaUID_contenedorFinanciero = data.instanciaUID_contenedorFinanciero
                                const ui = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_insertarDescuentosUI}"]`)
                                const contenedor = ui.querySelector("[componente=contenedor]")
                                contenedor.innerHTML = null
                                const spinner = casaVitini.ui.componentes.spinner({
                        ...
                        insertarOfertasCompatibles: {
                            ...
                            confirmarInsertarCompatible: async (data) => {
                                const reservaUID = this.reserva.data.reservaUID
                                const ofertaUID = String(data.ofertaUID)
                                const instanciaUID_insertarDescuentosUI = data.instanciaUID_insertarDescuentosUI
                                const instanciaUID_contenedorFinanciero = data.instanciaUID_contenedorFinanciero
                        ...
                        sobreControlPrecios: {
                            componentesUI: {
                                ...
                                nocheUI: async (data) => {
                                    ...
                                    const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                                    const uiRenderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_sobreControlUI}"]`)
                                    if (!uiRenderizada) { return }
                                    if (respuestaServidor?.error) {
                                ...
                                confirmar: async (data) => {
                                    ...
                                    const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                                    const instanciaPantallaCargaUI = this.shadowRoot.querySelector(`[instanciaUID="${instanciaPantallaCarga}"]`)
                                    instanciaPantallaCargaUI?.remove()
                                    const uiContenedorFinanciero = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_contenedorFinanciero}"]`)
                                    if (respuestaServidor?.error) {
                                        return casaVitini.ui.componentes.advertenciaInmersiva(respuestaServidor?.error)
                                    }
                                    if (respuestaServidor.ok) {
                                        const sobreControlUI = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_sobreControlUI}"]`)
                                        if (sobreControlUI) {
                                            casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                        }
                                        const selectorDesgloseEnPantalla = this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"] [componente=contenedorDesgloseTotal]`)
                                        if (!selectorDesgloseEnPantalla) {
                                            return
                                        }
                                        return this.reserva.categoriasGlobales.desgloseTotal.controladores.desplegarContenedorFinanciero({
                                            instanciaUID_contenedorFinanciero,
                                            reservaUID
                                        })
                                    }
                        ...
                        eliminarOfertaEnReserva: {
                            ...
                            confirmar: async (data) => {
                                ...
                                const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                                const instanciaRenderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
                                instanciaRenderizada.remove()
                                if (respuestaServidor?.error) {
                                    return casaVitini.ui.componentes.advertenciaInmersivaSuperPuesta(respuestaServidor?.error)
                                }
                        ...
                        insertarImpuesto: {
                            ui: async (data) => {
                                ...
                                const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                                const uiRenderizada = this.shadowRoot.querySelectorAll(`[instanciaUID="${instanciaUID_insertarImpuestoUI}"]`)
                                if (!uiRenderizada) { return }
                                if (respuestaServidor?.error) {
                                    casaVitini.shell.controladoresUI.limpiarAdvertenciasInmersivas()
                                    return casaVitini.ui.componentes.advertenciaInmersiva(respuestaServidor?.error)
                            ...
                            confirmarInsertar: async (data) => {
                                ...
                                const instanciaUID_contenedorFinanciero = data.instanciaUID_contenedorFinanciero
                                const ui = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_insertarImpuestoUI}"]`)
                                const contenedor = ui.querySelector("[componente=contenedor]")
                                contenedor.innerHTML = null
                                const spinner = casaVitini.ui.componentes.spinner({
                                    mensaje: "Insertando oferta en la reserva..."
                        ...
                        eliminarImpuesto: {
                            ui: async (data) => {
                                ...
                                const instanciaUID_contenedorFinanciero = data.instanciaUID_contenedorFinanciero
                                const reservaUID = this.shadowRoot.querySelector("[reservaUID]").getAttribute("reservaUID")
                                const pantallaInmersiva = casaVitini.ui.componentes.pantallaInmersivaPersonalizadaMoldeada()
                                pantallaInmersiva.style.justifyContent = "center"
                                const constructor = pantallaInmersiva.querySelector("[componente=constructor]")
                            ...
                            confirmarEliminar: async (data) => {
                                ...
                                const instanciaUID_contenedorFinanciero = data.instanciaUID_contenedorFinanciero
                                const ui = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_eliminarImpuestoUI}"]`)
                                const contenedor = ui.querySelector("[componente=constructor]")
                                contenedor.innerHTML = null
                                const spinner = casaVitini.ui.componentes.spinner({
                        ...
                        crearImpuestoAdHoc: {
                            ...
                            confirmarCrearImpuestoAdHoc: async (data) => {
                                const reservaUID = this.reserva.data.reservaUID
                                ...
                                const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                                this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_pantallaDeCargaSuperPuesta}"]`)?.remove()
                                const uiRenderizada = this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"]`)
                                if (!uiRenderizada) { return }
                                if (respuestaServidor?.error) {
                                    return casaVitini.ui.componentes.advertenciaInmersivaSuperPuesta(respuestaServidor?.error)
                        ...
                        reconstruirDesgloseFinanciero: {
                            ...
                            desdeInstantaneas: {
                                ...
                                confirmarReconstrucion: async (data) => {
                                    const reservaUID = this.reserva.data.reservaUID
                                    const instanciaUID_reconstrucion = data.instanciaUID_reconstrucion
                                    const instanciaUID_contenedorFinanciero = data.instanciaUID_contenedorFinanciero
                                    const ui = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_reconstrucion}"]`)
                                    const contenedor = ui.querySelector("[componente=constructor]")
                                    contenedor.innerHTML = null
                                    const spinner = casaVitini.ui.componentes.spinner({
                            ...
                            desdeHub: {
                                ...
                                confirmarReconstrucion: async (data) => {
                                    ...
                                    const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                                    const pantallaDeCarga_renderizda = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_pantallaDeCargaSuperPuesta}"]`)
                    ...
                    controladores: {
                        desplegarContenedorFinanciero: async (data) => {
                            ...
                            const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                            const instanciaRenderizada = this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"] [componente=contenedorDesgloseTotal]`)
                            ...
                            if (respuestaServidor?.ok) {
                                const totalGlobal = this.shadowRoot.querySelector("[dataReserva=totalReservaConImpuestos]")
                                const contenedorFinanciero = respuestaServidor.ok.contenedorFinanciero
                ...
                cancelarReserva: {
                        ...
                        if (respuestaServidor?.ok) {
                            ...
                            const botonCerrar = () => {
                                ...
                                ui.addEventListener("click", () => {
                                    this.reserva.categoriasGlobales.cancelarReserva.salirDelProceso(reservaUID)
                                })
                                return ui
                            }
                            contenedor.appendChild(botonCerrar())
                            if (estadoReservaIDV === "cancelada") {
                                ...
                                opcionBloqueoTemporalPorRango.addEventListener("click", this.reserva.categoriasGlobales.cancelarReserva.seleccionarOpcionBloqueoApartametos)
                                ...
                                opcionBloqueoPermanente.addEventListener("click", this.reserva.categoriasGlobales.cancelarReserva.seleccionarOpcionBloqueoApartametos)
                                ...
                                opcionBloqueoPorLiberacion.addEventListener("click", this.reserva.categoriasGlobales.cancelarReserva.seleccionarOpcionBloqueoApartametos)
                                ...
                                botonCancelar.addEventListener("click", () => {
                                    const tipoBloqueoIDV = this.shadowRoot.querySelector("[componente=cancelarReservaOpcionBloqueo][estado=activo]").getAttribute("cancelarReservatipoBloqueo")
                                    this.reserva.categoriasGlobales.cancelarReserva.confirmaCancelacion({
                                        tipoBloqueoIDV
                                    })
                                })
                            ...
                            botonEliminarReserva.addEventListener("click", this.reserva.categoriasGlobales.cancelarReserva.eliminarReservaIrreversiblemente.UI)
                    ...
                    seleccionarOpcionBloqueoApartametos: function (opcion) {
                        const selectorOpciones = this.shadowRoot.querySelectorAll("[componente=cancelarReservaOpcionBloqueo]")
                        const opcionBloqueo = opcion.target
                        const botonCancelar = this.shadowRoot.querySelector("[componente=botonConfirmarCancelarReserva]")
                    ...
                    confirmaCancelacion: async (data) => {
                        const instanciaUID_pantallaEspera = casaVitini.utilidades.codigoFechaInstancia()
                        const metadatosPantallaCarga = {
                        ...
                        const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                        const selectorPantallaDeCarga = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_pantallaEspera}"]`)
                        selectorPantallaDeCarga?.remove()
                        const reservaUI = this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"]`)
                        if (!reservaUI) { return }
                        if (respuestaServidor?.error) {
                            casaVitini.ui.componentes.advertenciaInmersivaSuperPuesta(respuestaServidor?.error)
                        } else if (respuestaServidor?.ok) {
                            ...
                            this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"] [dataReserva=estado]`).textContent = "Cancelada"
                            this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"] [contenedor=pendiente]`).style.display = "none"
                            this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"] [estadoReservaIDV]`).setAttribute("estadoReservaIDV", "cancelada")
                    ...
                    eliminarReservaIrreversiblemente: {
                        ...
                        confirmar: async (data) => {
                            const reservaUID = this.reserva.data.reservaUID
                            const instanciaUID = data.instanciaUID
                            const clave = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"] [campo=clave]`)
                            ...
                            const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                            const selectorPantallaDeCarga = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID_pantallDeCarga}"]`)
                            selectorPantallaDeCarga?.remove()
                            const reservaUI = this.shadowRoot.querySelector(`[reservaUID="${reservaUID}"]`)
                            if (!reservaUI) { return }
                            if (respuestaServidor?.error) {
                                this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"] [campo=clave]`).value = ""
                                return casaVitini.ui.componentes.advertenciaInmersivaSuperPuesta(respuestaServidor?.error)
                            }
                            if (respuestaServidor?.ok) {
                    ...
                    salirDelProceso: function (reservaUID) {
                        ...
                        const estado = {
                            ...
                            tipoCambio: "parcial",
                            componenteExistente: componentesExistenteUID,
                            funcionPersonalizada: "this.reserva.reservaUI.categorias.limpiarMenusCategorias"
                        }
                        window.history.pushState(estado, titulo, directoriosFusion);
                    },
                },
                miscelanea: {
                    arranque: async () => {
                        ...
                        const obtenerPDF = async () => {
                            ...
                            this.shadowRoot.appendChild(pantallaInmersiva)
                            const advertenciaInmersivaRenderizada = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
                            const transaccion = {
                                reservaUID
                            }
                            if (configuracionVista === "publica") {
                            ...
                            const respuestaServidor = await casaVitini.shell.servidor(transaccion)
                            const pantallaInmersivaRenderizda = this.shadowRoot.querySelector(`[instanciaUID="${instanciaUID}"]`)
...
customElements.define('reserva-ui', ReservaUI);
