export const sharedMethods = {
    componenteUI: {
        ...
        contenedorDescuento: function () {
            ...
            titulo.classList.add("padding14", "whiteSpace");
            titulo.textContent =
...
Esta opción permite aplicar descuentos individuales a los netos de los días seleccionados dentro de un rango o a los apartamentos seleccionados dentro de estos días.`;
            ...
            const descuentoIndividualPorApartmento = casaVitini.view.__sharedMethods__.componenteUI.descuentosUI.individualPorApartamento()
            contenedorDescuentos.appendChild(descuentoIndividualPorApartmento)
            const descuentoTotalNeto = casaVitini.view.__sharedMethods__.componenteUI.descuentosUI.totalNeto()
            contenedorDescuentos.appendChild(descuentoTotalNeto)
            const mismoDescuentoParaCadaApartamento = casaVitini.view.__sharedMethods__.componenteUI.descuentosUI.mismoDescuentoParaCadaApartamento()
            contenedorDescuentos.appendChild(mismoDescuentoParaCadaApartamento)
            const descuentoPorRango = casaVitini.view.__sharedMethods__.componenteUI.descuentosUI.porRango.arranque()
