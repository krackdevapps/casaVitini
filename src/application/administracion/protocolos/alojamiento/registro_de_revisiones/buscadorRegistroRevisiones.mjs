...
import { obtenerBusquedaRevisiones } from "../../../../../infraestructure/repository/protocolos/alojamiento/revision_alojamiento/obtenerBusquedaRevisiones.mjs";
...
export const buscadorRegistroRevisiones = async (entrada, salida) => {
    try {
        ...
        const resultadosBusqueda = await obtenerBusquedaRevisiones({
            numeroPagina: pagina,
