...
import { obtenerResultadosDeElementosEnLaCategoria } from "../../../../infraestructure/repository/inventario/categorias/obtenerResultadosDeElementosEnLaCategoria.mjs";

export const buscadorElementosEnCategoria = async (entrada,) => {
    try {
        ...
        const esquemaBusqueda = Joi.object({
            ...
            categoriaUID: Joi.string().custom((value, helpers) => {
                try {
                    return validadoresCompartidos.tipos.cadena({
                        string: value,
                        nombreCampo: "El categoriaUID",
                        filtro: "strictoIDV",
                        sePermiteVacio: "no",
        ...
        if (nombreColumna) {
            if (nombreColumna === "elemento_uid") {
                nombreColumna = "elementoUID"
            }
            if (nombreColumna === "categorias_uid") {
                nombreColumna = "categoriaUID"
            } if (nombreColumna === "categoria_ui") {
                nombreColumna = "categoriaUI"
            }
            await validadoresCompartidos.baseDeDatos.validarNombreColumna({
                nombreColumna: nombreColumna,
                tabla: "inventarioCategorias"
            })
        ...
        const resultadosBusqueda = await obtenerResultadosDeElementosEnLaCategoria({
            numeroPagina: pagina,
        ...
        if (nombreColumna) {
            if (nombreColumna === "elementoUID") {
                nombreColumna = "elemento_uid"
            }
            if (nombreColumna === "categoriaUID") {
                nombreColumna = "categorias_uid"
            } if (nombreColumna === "categoriaUI") {
                nombreColumna = "categoria_ui"
            }
