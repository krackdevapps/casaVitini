...
import { obtenerResultadosCategorias } from "../../../../infraestructure/repository/inventario/categorias/obtenerResultadosCategorias.mjs";

export const buscadorCategorias = async (entrada) => {
    try {
        ...
        const resultadosBusqueda = await obtenerResultadosCategorias({
            numeroPagina: pagina,
