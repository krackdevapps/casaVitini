...
import { obtenerTodosLosCalendarios } from "../calendariosSincronizados/airbnb/obtenerTodosLosCalendarios.mjs";
...
export const diasOcupadosTotalmentePorMes_ComponenteCompartido = async (data) => {
    try {
