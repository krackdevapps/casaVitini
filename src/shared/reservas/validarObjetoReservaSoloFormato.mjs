...
import { obtenerTodasLasConfiguracionDeLosApartamentosSoloDisponibles } from '../../infraestructure/repository/arquitectura/configuraciones/obtenerTodasLasConfiguracionDeLosApartamentosSoloDisponibles.mjs';
