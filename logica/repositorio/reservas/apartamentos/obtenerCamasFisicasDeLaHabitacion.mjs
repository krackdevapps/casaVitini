...
export const obtenerCamasFisicasDeLaHabitacion = async (data) => {
    try {
        ...
        *
        ...
        if (errorSi === "noExiste") {
            ...
            const error = "el adaptador obtenerCamasFisicasDeLaHabitacion necesita errorSi en existe, noExiste o desactivado"
            throw new Error(error)
        }
